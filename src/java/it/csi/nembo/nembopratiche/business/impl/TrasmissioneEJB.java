    ...
    try
    {
      ...
      if (idProcedimentoOggettoLock == null)
      {
        ...
        throw new ApplicationException(
            "Non � stata trovata alcuna pratica collegata a questo documento. Impossibile procedere con la trasmissione.");
      }
      ...
      /*
       * L'oggetto � sicuramente valorizzato altrimenti se l'idDocumentoIndex
       * non fosse presente su db mi avrebbe gi� fermato il controllo del lock.
       * Procedo con i controlli formali
       */
      if (procedimOggettoStampaDTO.getDataFine() != null)
      {
        // Non dovrebbe mai capitare, comunque � sempre meglio eseguire i test
        // del caso
        throw new ApplicationException(
       ...
       * comunque � sempre meglio eseguire il test
       */
      ...
      // Potrei avere pi� stampe da firmare, devono essere tutte firmate per
      // trasmettere
      ...
      {
        // Non � un errore applicativo ==> semplicemente non posso trasmettere
