    ...
    implements IAsyncEJB
{
	      ...
	      if (stampaOggetto != null)
	      {
	        ...
	        if (stampa == null)
	        {
	          logger.error(THIS_METHOD + " Errore nella generazione della stampa con idOggettoIcona #" + idOggettoIcona + " per il procedimento oggetto #"
	              ...
	              + "\nERRORE GRAVE:\nTipologia di stampa non registrata, non � stato trovata nessuna classe deputata a generare la stampa!\n\n");
	          dao.updateProcedimOggettoStampaByIdOggetoIcona(
	              idProcedimentoOggetto,
	              idOggettoIcona,
	              null,
	              NemboConstants.STATO.STAMPA.ID.STAMPA_FALLITA,
	              "Errore nella generazione della stampa:\nERRORE INTERNO GRAVE: Tipologia di stampa non registrata, non � stato trovata nessuna classe deputata a generare la stampa!",
	              idUtenteLogin);
	          return;
	        }
	        byte[] pdf = null;
      ...
      throws InternalUnexpectedException, IOException
  {
    ...
    // ID Quadro in questo caso non � significativo quindi posso usare un valore
