    ...
    implements IQuadroEJB
{
      ...
      ApplicationException
  {
    ...
    if (idAmmCompetenza != null)
    {
      ...
      {
        // Se non lo � ==> Eccezione, non posso modificare l'amministrazione di
        // competenza. (Se la jsp ha permesso di inserire il dato � probabile
        // che qualche
      ...
      // lo faccio solo se l'amm competenza � stato modificato!
          ...
          && oldIdAmmCompetenza.longValue() != idAmmCompetenza.intValue())
      {
        ...
        if (!updateOK)
        {
          // Non � avvenuto nessun update su db ==> il record non esiste ==> lo
          // inserisco
    ...
    for (GruppoInfoDTO info : dichiarazioni)
    {
      for (DettaglioInfoDTO dettaglio : info.getDettaglioInfo())
      {
        ...
        if (dettaglio.isChecked())
        {
          ...
          {
            // � inutile salvare nel database le informazioni obbligatorie che
    ...
    else
    {
      if (idSelezione == null)
      {
        throw new InternalUnexpectedException(
            "Tentativo di inserire un allegato NON OBBLIGATORIO di cui non � gi� presente l'ID_SELEZIONE_INFO.",
            new LogParameter[]
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    {
      // Se no, non c'� nulla da fare, � gi� stato eliminato da qualcun altro
    }
  }
      ...
      throws ApplicationException, InternalUnexpectedException
  {
    ...
    try
    {
      if (stampa != null)
      {
        ...
        {
          // Se ho eliminato qualcosa � segno che gli id passati sono corretti
          ...
          catch (Exception e)
          {
            logger.error(THIS_METHOD
                ...
                + e.getMessage(), e);
            throw new ApplicationException(
                "Si � verificato un errore nell'accesso al servizio di cancellazione AGRIWELL, se il problema persistesse si prega di contattare l'assistenza tecnica");
          }
          Integer codice = esito == null ? null : esito.getEsito();
          if (codice == null
              || codice != NemboConstants.SERVICE.AGRIWELL.RETURN_CODE.SUCCESS)
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      if (stampa != null)
      {
        ...
        {
          // Procedo solo non c'� il documento index
          if (stampa
              .getIdStatoStampa() == NemboConstants.STATO.STAMPA.ID.GENERAZIONE_STAMPA_IN_CORSO)
          {
            ...
            // rigenerazione == > non faccio nulla, una stampa � gi� in corso
            // Questo caso, se non ci sono errori � dovuto al fatto che pi�
          ...
          else
          {
            ...
            // EXT_ID_DOCUMENTO_INDEX non pu� essere andato bene... ==> RIGENERO
            dao.ripristinaProcedimOggettoStampaByIdOggetoIcona(
                idProcedimentoOggetto, idOggettoIcona, idUtenteLogin);
            return true;
          }
    ...
    try
    {
      ...
      try
      {
        ...
        sb = new StringBuilder("Per l'azienda ")
            ...
            .append(" � stato cancellato il procedimento oggetto con id: ")
  ...
  public String aggiungiOggettoStampa(ProcedimOggettoStampaDTO stampa,  UtenteAbilitazioni utenteAbilitazioni) throws InternalUnexpectedException
  {
    ...
    {
      return "E' gi� presente un documento allegato per la tipologia prescelta! Se lo si desidera cambiare si prega di eliminare prima quello presente";
    }
    try
    {
    ...
    catch (Exception e)
    {
      ...
      sessionContext.setRollbackOnly();
      return "Si � verificato un problema nella registrazione del documento. Se il problema persistesse si prega di contattare l'assistenza tecnica";
    }
  }
    ...
    try
    {
      ...
      switch (result.getRisultato())
      {
        ...
        case NemboConstants.SQL.RESULT_CODE.ERRORE_CRITICO:
          return "<br />Si � verificato un errore di sistema. Contattare l'assistenza comunicando il seguente messaggio: "
              + result.getMessaggio();
        case NemboConstants.SQL.RESULT_CODE.ERRORE_GRAVE:
          return "<br />E' stato riscontrato il seguente errore: "
              + result.getMessaggio();
        default:
          return "<br />Si � verificato un problema grave nella riapertura dell'oggetto, se il problema persistesse contattare l'assistenza tecnica.";
      }
    }
    catch (Exception e)
    {
      ...
      { new LogParameter("idProcedimentoOggetto", idProcedimentoOggetto) },
          null, THIS_METHOD);
      sessionContext.setRollbackOnly();
      return "Si � verificato un problema nella riapertura dell'oggetto. Se il problema persistesse si prega di contattare l'assistenza tecnica";
    }
    finally
    {
      if (logger.isDebugEnabled())
      ...
      throws InternalUnexpectedException
  {
    ...
    catch (Exception e)
    {
      ...
      { new LogParameter("idProcedimentoOggetto", idProcedimentoOggetto) },
          null, THIS_METHOD);
      sessionContext.setRollbackOnly();
      return "Si � verificato un problema nella riapertura dell'oggetto. Si prega di contattare l'assistenza tecnica";
    }
    finally
    {
      if (logger.isDebugEnabled())
  ...
  public String trasmettiIstanza(long idProcedimento, long idProcedimentoOggetto, long idBandoOggetto,long idQuadroOggettoDatiIdentificativi, String identificativoProcOggetto, UtenteAbilitazioni utenteAbilitazioni) throws InternalUnexpectedException
  {
	...
	try
	{
		...
		{
		  return "L'oggetto non si trova nello stato corretto per la trasmissione o � gi� stato trasmesso. Impossibile proseguire con l'operazione";
		}
		...
		{
			   sessionContext.setRollbackOnly();
		      return"Per procedere � necessario inserire la stampa firmata.";
		}
	...
	catch (Exception e)
    {
      ...
      sessionContext.setRollbackOnly();
      return "Si � verificato un problema nella trasmissione dell'istanza. Se il problema persistesse si prega di contattare l'assistenza tecnica";
    }
	finally
    {
      if (logger.isDebugEnabled())
		...
		try {
			  ...
			  try{
				 ...
				 if(protRespnse != null){
					 ...
					 logger.error( " si � verificato un problema durante il richiamo al servizio di protocollazione. idProcedimOggettoStampa="+idProcedimOggettoStampa);
					 sessionContext.setRollbackOnly();
				 ...
				 /*
					...
					if(destinatarioMailNotifica!=null)
					{
						...
						NemboUtils.MAIL.postMail("noreply@regione.basilicata.it", new String[] {destinatarioMailNotifica}, null,
      ...
      boolean isIstanzaPagamento) throws InternalUnexpectedException
  {
    ...
    if (isIstanza)
    {
          ...
          mapParametri.get(NemboConstants.PARAMETRO.DOQUIAGRI_FLAG_PEC)))
      {
        ...
        {
          throw new InternalUnexpectedException(
              "Si � verificato un errore durante la composizione della PEC. Si prega di contattate l'assistenza tecnica.",
              e);
        }
      }
    }
      ...
      long idUtenteLogin) throws InternalUnexpectedException
  {
    ...
    catch (Exception e)
    {
      ...
      sessionContext.setRollbackOnly();
      throw new InternalUnexpectedException(
          "Si � verificato un errore durante l'aggiornamento dei dati.", e);
    }
    finally
    {
      if (logger.isDebugEnabled())
  ...
  @Override
	public String approvaIstanza(long idProcedimento, long idProcedimentoOggetto, long idBandoOggetto, String identificativoProcOggetto, UtenteAbilitazioni utenteAbilitazioni,long idQuadroOggettoDatiIdentificativi) throws InternalUnexpectedException
	{
	    ...
	    try
		{
			...
			if(trovato >1)
			{
				//Ho gi� un oggetto simile nel procedimento -> gestisco esito P e N
                ...
                sessionContext.setRollbackOnly();
                return "Si � verificato un problema durante la storicizzazione del procedimento. Se il problema persistesse si prega di contattare l'assistenza tecnica";
				}
			}
			else
			{
				//NON ho gi� un oggetto simile nel procedimento -> gestisco esito P ,N, PN
				if(NemboConstants.STATO.ESITO.ID.TIPO_ESITO_O.POSITIVO == po.getIdEsito())
				{
					dao.updateProcedimentoOggetto(idProcedimentoOggetto,  NemboConstants.STATO.ESITO.ID.APPROVATA_POSITIVO, utenteAbilitazioni.getIdUtenteLogin());
					dao.updateProcedimento(idProcedimento, NemboConstants.STATO.PROCEDIMENTO.ID.AMMESSO_FINANZIAMENTO, utenteAbilitazioni.getIdUtenteLogin());
		...
		catch (Exception e)
	    {
			DumpUtils.logGenericException(logger, null, e, new LogParameter[]{new LogParameter("idProcedimentoOggetto", idProcedimentoOggetto)}, null, THIS_METHOD);
	    	sessionContext.setRollbackOnly();
	    	return "Si � verificato un problema nell'approvazione. Se il problema persistesse si prega di contattare l'assistenza tecnica";
	    }
		finally
	  {
	    if (logger.isDebugEnabled())
      ...
      throws InternalUnexpectedException
  {
    ...
    // controllo se non � collegato a proc_ogg posso eliminare gli allegati e il
    // doc
    ...
    for (DettaglioInterventoDTO intervento : listaInterventi)
      for (DocumentoSpesaVO doc : intervento.getIntervento()
        ...
        for (RicevutaPagamentoVO r : doc.getElencoRicevutePagamento())
        {
          ...
          // se un intervento � stato rimosso e quindi non pi� associato al
          // documento??
          ...
          // se l'importo � zero lo inserisco cmq, se null NO
      ...
      String flagRendicontazioneConIva) throws InternalUnexpectedException
  {
    ...
    if (documenti != null)
    {
      for (DocumentoSpesaVO doc : documenti)
      {
        ...
        /*
         * Mostro l'icona dell'euro solo se il doc non � stato gi� completamente
         * rendicontato
         */
      ...
      String flagRendicontazioneConIva) throws InternalUnexpectedException
  {
     ...
     * collegato non valido (non � between 10 and 90)
     */
      ...
      throws InternalUnexpectedException
  {
    ...
    if (dao.canDeleteFile(idDocumentoSpesaFile) // se non ci sia gi� un record
