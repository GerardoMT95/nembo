...
import it.csi.nembo.nembopratiche.dto.listeliquidazione.RisorseImportiOperazioneDTO;
...
import it.csi.nembo.nembopratiche.integration.ListeLiquidazioneDAO;
...
public class ListeLiquidazioneEJB extends
    NemboAbstractEJB<ListeLiquidazioneDAO> implements IListeLiquidazioneEJB
{
  ...
  public DatiCreazioneListaDTO creaListaLiquidazione(long idBando,
      ...
      long idUtenteAggiornamento, List<Long> idsPODaEscludere)
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    if (NemboUtils.NUMBERS.nvl(idMaxListaLiquidazioneCorrente,
        Long.MIN_VALUE) != NemboUtils.NUMBERS
                ...
                Long.MIN_VALUE))
    {
       ...
       * Incompatibilit� grave ==> impossibile creare la lista ==> segnalo
       * all'utente la situazione forzando il ricarico dei dati con una
       * ApplicationException
       */
      throw new ApplicationException(
          "Attenzione! Si � verificato un errore grave nella creazione lista: un altro utente ha creato nel frattempo una lista di liquidazione su questo stesso bando, per la stessa amministrazione e lo stesso Tipo importo. Impossibile proseguire con la creazione");
    }
    /*
    ...
    if (!dao.checkTecnicoLiquidatoreNonIstruttore(idBando, idAmmCompetenza,
        idTipoImporto, idTecnicoLiquidatore, null, idsPODaEscludere))
    {
      throw new ApplicationException(
    ...
    // Se sono arrivato qua � perch� non sono state create nuove liste che
    ...
    if (risorseAttuali == null || risorseAttuali.isEmpty())
    {
      ...
      // comunque meglio una verifica in pi� che
      // una in meno
      throw new ApplicationException(
          "Attenzione! Si � verificato un errore grave nella creazione lista: Non sono state assegnate delle risorse finanziarie per il bando selezionato");
    }
    ...
    if (risorseAttuali.size() != risorseUtente.size())
    {
      ...
      // allora c'� sicuramente stato un cambiamento che non pu� essere ignorato
    ...
    if (!hasImportiDaLiquidare)
    {
      ...
      throw new ApplicationException(
          "Attenzione! Si � verificato un errore grave nella creazione lista: Non esistono pratiche da pagare per questa lista");
    }
    ...
    /**
     * ATTENZIONE: L'ordine seguente dei 2 metodi � importante, PRIMA bisogna
     * inserire la tabella NEMBO_R_RISORSE_LIV_BANDO e poi la tabella
     * NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ perch� la query che estrae i record da
     ...
     * importi ripartiti come percentuale cio� quelli con
     ...
     * differenza cio� quelli con FLAG_CRITERIO_RIPARTIZIONE = 'D' (in sostanza
     * mi disinteresso della percentuale di ripartizione ma faccio la differenza
     * tra l'importo liquidato e i record gi� inseriti al punto precedente per
     ...
     * Prendo l'elemento con indice 0. Nessun controllo... Esiste perch� l'ho
     * appena inserita e nessuno pu� averla cancellata dato che non � ancora
    ...
    /**
     * Perch� tutto sia andato a buon fine occorre che il numero pagamenti e
     * l'importo totale da liquidare della lista siano uguali a quelli
     * presentati all'utente, altrimenti � intervenuto qualcosa che ha cambiato
    ...
    {
      /**
       * In questo caso, al 99% il problema � dovuto al fatto che qualche utente
       ...
       */
      throw new ApplicationException(
          "Attenzione! Si � verificato un errore grave nella creazione lista: sono avvenute delle modifiche che hanno comportato una variazione del numero delle pratiche o importo liquidabili. Impossibile procedere");
    }
  ...
  void gestisciRisorse(RisorseImportiOperazioneDTO risorsa){
          ...
          .getNumeroPagamentiLista())
      {
        ...
        throw new ApplicationException(
            "Attenzione! Si � verificato un errore grave nella creazione lista: il numero di pratiche e/o l'importo totale da liquidare � variato, probabilmente nel frattempo sono state ammesse a pagamento altre pratiche");
      }
      ...
      {
        // Per questa operazione ci sono delle pratiche da liquidare ma non c'�
        // copertura ==> Errore grave!
        throw new ApplicationException(
            "Attenzione! Si � verificato un errore grave nella creazione lista: Nel frattempo sono intervenute delle modifiche sulle risorse finanziarie, oppure sono state gerenate da un altro utente liste di liquidazione sullo stesso bando che non permettono pi� la copertura finanziaria");
      }
  }
      ...
      throws InternalUnexpectedException
  {
    try
    {
      ...
      dao.deleteRImportiRipartiti(idListaLiquidazione); // non c'� nell'analisi
                                                        // ma direi che va anche
                                                        // pulita questa
      dao.delete("NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ", "ID_LISTA_LIQUIDAZIONE",
          idListaLiquidazione);
      dao.delete("NEMBO_T_LISTA_LIQUIDAZIONE", "ID_LISTA_LIQUIDAZIONE",
          idListaLiquidazione);
    }
      ...
      throws InternalUnexpectedException
  {
    ...
    if (stampaListaLiq != null)
    {
      ...
      // minuti
      {
        // Se lo stato � generazione in corso, per aggiornare il record deve
        // essere passato un certo tempo (10 minuti di
        // default)
        // Non � ancora passato il lasso di tempo per permettere la
        // rigenerazione == > non faccio nulla, una stampa �
        // gi� in corso
        // Questo caso, se non ci sono errori � dovuto al fatto che pi� utenti
        ...
        // il record
        // gi� aggiornato, quindi non fa nulla.
    ...
    else
    {
      ...
      // EXT_ID_DOCUMENTO_INDEX non pu� essere andato bene...
      // ==> RIGENERO
      dao.ripristinaListaLiquidazione(stampaListaLiq);
      return true;
    }
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    try
    {
      ...
      {
        throw new ApplicationException(
            "La lista di liquidazione indicata � approvata, impossibile proseguire");
      }
   ...
   * ApplicationException ma la ritorna al chiamante. Questo perch�, nel caso di
   ...
   * potenzialmente pericolosa) si � preferito restituire l'eccezione.
   */
  @Override
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      {
        throw new ApplicationException(
            "La lista di liquidazione indicata � gi� approvata, impossibile proseguire");
      }

      if (dao.isListaLiquidazioneCorrotta(idListaLiquidazione))
      {
        throw new ApplicationException(
            "La lista di liquidazione indicata � corrotta (a causa di un precedente tentativo non riuscito di approvazione), impossibile procedere. Si prega di contattare l'assistenza tecnica comunicando il seguente messaggio: La lista di liquidazione con ID="
                + idListaLiquidazione + " � corrotta");
      }
      ...
      String[] PARAM_NAMES =
      {
          NemboConstants.PARAMETRO.DOQUIAGRI_USR_PSW_SC,
      ...
      for (String param : PARAM_NAMES)
      {
        ...
        {
          throw new ApplicationException(
              "Si � verificato un errore interno grave, impossibile proseguire. Contattare l'assistenza tecnica comunicando il seguente messaggio: Parametro \""
                  + param + "\" non presente");
        }
      }
      ...
      /*
       * A questo punto la lista � su Agriwell / Doqui. Quindi nel caso qualcosa
      ...
      catch (Exception e)
      {
         ...
         * se i dati su db non resteranno congruenti: l'obiettivo � tenere
         * traccia in qualsiasi modo che la lista sia gi� stata mandata al
         * documentale ed evitare di rimandarla. Se l'errore � avvenuto
         * sull'aggiornamento di NEMBO_T_FILE_LISTA_LIQUIDAZIONE non c'� nulla
         ...
         */
        throw new ApplicationException(
            "Si � verificato un errore interno GRAVE nell'applicazione. "
                + "La lista di liquidazione � stata registrata e protocollata sul documentale ma non � stato possibile aggiornare la base dati. "
    ...
    {
      logger.error("Si � verificato una eccezione ApplicationException", e);
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    try
    {
      SiapCommWsDocumentoInputVO inputVO = NemboUtils.WS
          .getSiapCommDocumentoVOPerArchiviazioneListeLiquidazione(
              listaLiquidazioneDTO,
              mapParametri,
              NemboUtils.FILE.getSafeSubmittedFileName(
                  stampaFirmata.getOriginalFilename()),
              emailAmmCompetenza,
              idUtenteAggiornamento,
        ...
        | MalformedURLException | UnrecoverableException e)
    {
      logger.error("[" + THIS_CLASS + "." + THIS_METHOD
          + " Si � verificato un errore nel richiamo del servizio archiviaProtocollaDocumento() di agriwell. Il messaggio di errore restituito �: "
          + e.getMessage());
      dao.scriviEccezioneAgriwell(idListaLiquidazione, e);
      throw new ApplicationException(
          "Si � verificato un errore nella registrazione/protocollazione della lista di liquidazione sul sistema documentale. Se il problema persistesse si prega di contattare l'assistenza tecnica");
    }
    catch (Exception e)
    {
      logger.error("[" + THIS_CLASS + "." + THIS_METHOD
          + " Si � verificato un errore generico nell'invio della lista di liquidazione sul documentale di agriwell. Il messaggio di errore restituito �: "
          + e.getMessage());
      dao.scriviEccezioneAgriwell(idListaLiquidazione, e);
      throw new ApplicationException(
          "Si � verificato un errore nella registrazione/protocollazione della lista di liquidazione sul sistema documentale. Se il problema persistesse si prega di contattare l'assistenza tecnica");
  ...
  void archiviazioneListeLiquidazione(SiapCommWsDocumentoInputVO inputVO){
      ...
      if (NemboConstants.FLAGS.SI.equals(inputVO.getFlagTimbroProtocollo()))
      {
        String[] PARAM_NAMES_COORDINATE_LISTE_LIQUIDAZIONE =
        {
            ...
            NemboConstants.PARAMETRO.DOQUIAGRI_LISTE_LIQUIDAZIONE_Y_ALTO,
            NemboConstants.PARAMETRO.DOQUIAGRI_LISTE_LIQUIDAZIONE_Y_BASSO
        };
        ...
        NemboUtils.WS.addMetadatiCoordinateProtocolloListaLiquidazione(
      ...
      EsitoDocumentoVO esito = NemboUtils.WS.getSiapComm()
          ...
          && codice == NemboConstants.SERVICE.AGRIWELL.RETURN_CODE.SUCCESS)
      {
        logger.info("[" + THIS_CLASS + "." + THIS_METHOD
            ...
            + " � stata archiviata e protocollata con idDocumentoIndex = "
      ...
      else
      {
        ...
        final String errorMessage = "Si � verificato un errore nel richiamo dels servizio archiviaProtocollaDocumento() di agriwell. Il messaggio di errore restituito �: "
            + messaggioErrore;
