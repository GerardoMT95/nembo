...
public class RendicontazioneEAccertamentoSpeseEJB
    extends NemboAbstractEJB<RendicontazioneEAccertamentoSpeseDAO>
    implements IRendicontazioneEAccertamentoSpeseEJB
{
      ...
      throws InternalUnexpectedException
  {
    ...
    // Elimino tutti i record su NEMBO_R_PROCEDIMENTO_OGG_LIVEL
    dao.delete("NEMBO_R_PROCEDIMENTO_OGG_LIVEL", "ID_PROCEDIMENTO_OGGETTO",
     ...
     * influenzerebbero i valori Cio� se il
    ...
    /*
     * 1) elimino le eventuali sanzioni gi� inserite
     */
      ...
      for (RiduzioniSanzioniDTO r : riduzioni)
      {
        if (r.isSplitted())
        {
          if (r != null && r.getIdProcOggSanzione() != null)
            dao.delete("NEMBO_T_PROC_OGGETTO_SANZIONE",
  ...
  /**
   * Metodo di utilit� da richiamare da altri ejb per aggiornare i totali per
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    {
      BigDecimal percentuale = NemboUtils.NUMBERS
          .getBigDecimal(percentuali[0]);
      if (percentuale == null)
      {
        throw new ApplicationException(
            "Errore bloccante grave, si prega di contattare l'assistenza tecnica e comunicare il seguente messaggio: Formato VALORE PARAMETRO per controllo REN01 non corretto, la prima percentuale non � un numero valido");
      }
      return percentuale;
    }
    else
    {
      ...
      {
        throw new ApplicationException(
            "Errore bloccante grave, si prega di contattare l'assistenza tecnica e comunicare il seguente messaggio: Formato VALORE PARAMETRO per controllo REN01 non corretto, la seconda percentuale non � un numero valido");
      }
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    try
    {
          ...
          .values())
      {
            ...
            .getRendicontazione())
        {
              ...
              riga.getIdDocumentoSpesaInterven()))
          {
            ...
            // NEMBO_R_DOCUMENTO_SPESA_INTERV ==> Pu� essere un problema
            // di concorrenza o di altra natura ma non � una situazione
      ...
      /**
       * Integrazione con i file di spesa (tabella NEMBO_R_DOC_SPESA_PROC_OGG)
       */
    ...
    try
    {
          ...
          .values())
      {
            ...
            .getAccertamento())
        {
          ...
          contributoCalcolato = NemboUtils.NUMBERS.add(contributoCalcolato,
              riga.getImportoCalcoloContributoBD());
          importoAccertato = NemboUtils.NUMBERS.add(importoAccertato,
              riga.getImportoAccertatoBD());
          importoCalcoloContributo = NemboUtils.NUMBERS.add(
              importoCalcoloContributo,
              riga.getImportoCalcoloContributoBD());
          importoDisponibile = NemboUtils.NUMBERS.add(importoDisponibile,
              riga.getImportoDisponibileBD());
          importoNonRiconosciuto = NemboUtils.NUMBERS
        ...
        contributoCalcolato = NemboUtils.NUMBERS.multiply(
