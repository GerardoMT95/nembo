...
import it.csi.nembo.nembopratiche.integration.BaseDAO;
    ...
    implements INemboAbstractEJB
{
  ...
  private static final String   THIS_CLASS = NemboAbstractEJB.class
      .getSimpleName();
  @Resource
  ...
  {
	  return dao.getInformazioniBandoByIdProcOgg(idProcOggetto);
  }
}
