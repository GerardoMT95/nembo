...
public class RendicontazioneEAccertamentoSpeseDAO extends InterventiBaseDAO
{
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                 \n"
        ...
        + "       POL.ID_LIVELLO                                                   \n"
        + "     FROM                                                               \n"
        + "       NEMBO_R_PROCEDIMENTO_OGG_LIVEL POL                               \n"
        + "     WHERE                                                              \n"
        ...
        + "       POS.ID_LIVELLO                                                   \n"
        + "     FROM                                                               \n"
        + "       NEMBO_T_PROC_OGGETTO_SANZIONE POS                                  \n"
        + "     WHERE                                                              \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String INSERT = " INSERT                                                                                             \n"
        + " INTO                                                                                               \n"
        + "   NEMBO_R_PROCEDIMENTO_OGG_LIVEL                                                                   \n"
        + "   (                                                                                                \n"
        ...
        + "         FROM                                                                                       \n"
        + "           NEMBO_T_RENDICONTAZIONE_SPESE RS,                                                          \n"
        + "           NEMBO_T_PROCEDIMENTO_OGGETTO PO_ORIG,                                                      \n"
        + "           NEMBO_T_PROCEDIMENTO_OGGETTO PO,                                                           \n"
        + "           NEMBO_T_PROCEDIMENTO P,                                                                    \n"
        + "           NEMBO_T_ITER_PROCEDIMENTO_OGGE IPO,                                                      \n"
        + "           NEMBO_T_ACCERTAMENTO_SPESE ASP,                                                            \n"
        ...
        + "               NEMBO_T_RENDICONTAZIONE_SPESE RS2,                               \n"
        + "               NEMBO_T_ITER_PROCEDIMENTO_OGGE IPO2                            \n"
        + "             WHERE                                                            \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String INSERT = " DELETE FROM                                                          \n"
        ...
        + "     FROM                                                             \n"
        + "       NEMBO_D_SANZIONE_INVESTIMENTO SI                                 \n"
        + "     WHERE                                                            \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String INSERT = " INSERT INTO                                                                                    \n"
        ...
        + " (                                                                                              \n"
        + "   SELECT                                                                                       \n"
        + "     SEQ_NEMBO_T_PROC_OGGETTO_SANZI.NEXTVAL,                                                    \n"
        + "     :ID_PROCEDIMENTO_OGGETTO,                                                                  \n"
        + "     POS.ID_LIVELLO,                                                                            \n"
        ...
        + "     )                                                                                          \n"
        + "     C,                                                                                         \n"
        + "     NEMBO_R_PROCEDIMENTO_OGG_LIVEL POS,                                                        \n"
        + "     NEMBO_T_CONTROLLO_IN_LOCO_INVE CILI,                                                       \n"
        + "     NEMBO_D_SANZIONE_INVESTIMENTO DSI,                                                           \n"
        + "     NEMBO_D_LIVELLO L                                                                            \n"
        + "   WHERE                                                                                        \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY_UPDATE_NON_EROGABILE = " UPDATE                                                                                                                                 \n"
        + "   NEMBO_R_PROCEDIMENTO_OGG_LIVEL POL2                                \n"
        + " SET                                                                  \n"
        + "   CONTRIBUTO_NON_EROGABILE =                                         \n"
        + "   (                                                                  \n"
        + "     SELECT                                                           \n"
    ...
    final String QUERY_UPDATE_NON_EROGABILE_SE_INFERIORE = " UPDATE                                                                    \n"
        + "   NEMBO_R_PROCEDIMENTO_OGG_LIVEL PROCOGGLIV                               \n"
        + " SET                                                                       \n"
        + "   CONTRIBUTO_NON_EROGABILE =                                              \n"
        + "   (                                                                       \n"
        + "     SELECT                                                                \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " WITH                                                                                \n"
        ...
        + "                                                                       AS CONTRIBUTO \n"
        + "     FROM                                                                            \n"
        + "       NEMBO_R_PROCEDIMENTO_OGG_LIVEL RPOL,                                          \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO TPOD,                                              \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO TPOI,                                              \n"
        + "       NEMBO_D_ESITO DE                                                                \n"
        + "     WHERE                                                                           \n"
      ...
      long idProcedimentoOggetto) throws InternalUnexpectedException
  {
    ...
    String UPDATE = " UPDATE                                                                \n"
        + "   NEMBO_T_ACCERTAMENTO_SPESE ACC                                        \n"
        + " SET                                                                   \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY_SALDO = " WITH                                                                                                     \n"
        ...
        + "       NEMBO_T_DETTAGLIO_INTERVENTO DI,                                                                     \n"
        + "       NEMBO_D_TIPO_CLASSIFICAZIONE TC,                                                                     \n"
        + "       NEMBO_R_AGGREGAZIONE_INTERVENT AI,                                                                  \n"
        + "       NEMBO_D_TIPO_AGGREGAZIONE TA,                                                                        \n"
    ...
    mapParameterSource.addValue("FLAG_ESCLUDI_CATALOGO",
        NemboConstants.FLAGS.NO, Types.VARCHAR);
    try
    {
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                               \n"
        ...
        + "   NEMBO_T_PROC_OGGETTO_SANZIONE POS,                                   \n"
        + "   NEMBO_T_PROCEDIMENTO_OGGETTO PO_ORIG,                                \n"
        + "   NEMBO_T_PROCEDIMENTO_OGGETTO ISTR,                                   \n"
        + "   NEMBO_D_ESITO E                                                      \n"
        + " WHERE                                                                \n"
        + "   PO_ORIG.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO         \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = "SELECT ID_LIVELLO FROM NEMBO_R_PROCEDIMENTO_OGG_LIVEL WHERE ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO \n";
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = "  WITH ISTANZE AS (                                                                                                                                                                \n"
        ...
        + "   D.DESCRIZIONE,                                                                                                                                                                  \n"
        + "   (SELECT C2.DATA_INIZIO FROM NEMBO_T_ITER_PROCEDIMENTO_OGGE C2 WHERE C2.ID_STATO_OGGETTO = 10 AND C2.ID_PROCEDIMENTO_OGGETTO = B.ID_PROCEDIMENTO_OGGETTO) AS DATA_PRESENTAZIONE, \n"
        + "   C.ID_LEGAME_GRUPPO_OGGETTO,                                                                                                                                                     \n"
        + "   C.ID_GRUPPO_OGGETTO                                                                                                                                                             \n"
        + "  FROM                                                                                                                                                                             \n"
        + "   NEMBO_T_PROCEDIMENTO A,                                                                                                                                                           \n"
        + "   NEMBO_T_PROCEDIMENTO_OGGETTO B,                                                                                                                                                   \n"
        ...
        + "          FROM                                                                                                                                                                     \n"
        + "           NEMBO_T_PROCEDIMENTO A3,                                                                                                                                                  \n"
        + "           NEMBO_T_PROCEDIMENTO_OGGETTO B3,                                                                                                                                          \n"
        + "           NEMBO_R_LEGAME_GRUPPO_OGGETTO C3,                                                                                                                                         \n"
        + "           NEMBO_D_OGGETTO D3                                                                                                                                                        \n"
        + "          WHERE                                                                                                                                                                    \n"
        ...
        + "               FROM                                                                                                                                                                \n"
        + "                 NEMBO_T_PROCEDIMENTO_OGGETTO POISTR,                                                                                                                                \n"
        + "                 NEMBO_R_LEGAME_GRUPPO_OGGETTO LGOISTR                                                                                                                               \n"
        + "               WHERE                                                                                                                                                               \n"
        ...
        + "         FROM                                                                                                                                                                      \n"
        + "          NEMBO_T_RENDICONTAZIONE_SPESE Z2                                                                                                                                           \n"
        + "         WHERE                                                                                                                                                                     \n"
        ...
        + "      FROM                                                                                                                                                                         \n"
        + "       NEMBO_R_LEGAME_GRUPPO_OGGETTO C2,                                                                                                                                             \n"
        + "       NEMBO_D_OGGETTO D2,                                                                                                                                                           \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO B2,                                                                                                                                              \n"
        + "       NEMBO_T_PROC_OGGETTO_SANZIONE Z2                                                                                                                                              \n"
        + "      WHERE                                                                                                                                                                        \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                       		 \n"
        + "   FLAG_CONTROLLO											 \n"
        + " FROM                                                         \n"
        + "   NEMBO_T_CONTROLLO_IN_LOCO_INVE                             \n"
        + " WHERE                                                        \n"
        + "    ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO     \n";
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
    try
      ...
      throws InternalUnexpectedException
  {
    ...
    String DELETE = " DELETE FROM NEMBO_T_PROC_OGGETTO_SANZIONE   POS                                 \n"
        + "        WHERE ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO		 	  	\n";

    if (flag != null && flag.compareTo("S") == 0)
      DELETE += "	AND  ID_SANZIONE_INVESTIMENTO = (SELECT  ID_SANZIONE_INVESTIMENTO FROM  NEMBO_D_SANZIONE_INVESTIMENTO WHERE CODICE_IDENTIFICATIVO = 'S01' )     \n";
    else
      DELETE += "	AND  ID_SANZIONE_INVESTIMENTO = (SELECT  ID_SANZIONE_INVESTIMENTO FROM  NEMBO_D_SANZIONE_INVESTIMENTO WHERE CODICE_IDENTIFICATIVO = 'S02' )     \n";
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = "SELECT													\n"
        ...
        + "			SUM (IMPORTO) 												\n"
        + "		FROM 															\n"
        + "			NEMBO_T_PROC_OGGETTO_SANZIONE POS2 ,							\n"
        + "			 NEMBO_D_SANZIONE_INVESTIMENTO SI2						    \n"
        + "		WHERE 															\n"
      ...
      int annoCampagna) throws InternalUnexpectedException
  {
    ...
    String QUERY = " WITH                                                                                                                               \n"
        ...
        + "       END AS CODICE                                                                                                                \n"
        + "     FROM                                                                                                                           \n"
        + "       NEMBO_W_DETT_INTERV_PROC_OGG DIPO,                                                                                             \n"
        + "       NEMBO_D_DESCRIZIONE_INTERVENTO DI,                                                                                             \n"
        + "       NEMBO_T_INTERVENTO I                                                                                                           \n"
        + "     WHERE                                                                                                                          \n"
        ...
        + "     FROM                                                                                                                           \n"
        + "       NEMBO_W_LOCAL_INTERV_PROC_OGG LIPO,                                                                                            \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String INSERT = " UPDATE                                              \n"
        + "   NEMBO_R_PROCEDIMENTO_OGG_LIVEL P                            \n"
        + " SET                                                           \n"
        + "   P.SANZIONI =                                                \n"
        + "   (                                                           \n"
        + "     SELECT                                                    \n"
        + "       SUM(POL.IMPORTO)				                          \n"
        + "     FROM                                                      \n"
        + "       NEMBO_T_PROC_OGGETTO_SANZIONE POL 	                      \n"
        + "     WHERE                                                     \n"
      ...
      List<Long> idIntervento) throws InternalUnexpectedException
  {
    ...
    String QUERY = " WITH                                                                                                                      \n"
        ...
        + "       IMPORTO_DISPONIBILE                                                                                                 \n"
        + "     FROM                                                                                                                  \n"
        + "       NEMBO_R_DOC_SPESA_INT_ACC_SPES DSIAS,                                                                                \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO PO,                                                                                      \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO PO_ORIG,                                                                                 \n"
        + "       NEMBO_T_ITER_PROCEDIMENTO_OGGE IPO,                                                                                 \n"
        + "       NEMBO_D_ESITO E                                                                                                       \n"
        ...
        + "     FROM                                                                                                                  \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO PO_ORIG,                                                                                 \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO ISTANZA,                                                                                 \n"
        ...
        + "           *                                                                                                               \n"
        + "         FROM                                                                                                              \n"
        + "           NEMBO_T_PROCEDIMENTO_OGGETTO ISTRUTTORIA,                                                                         \n"
        + "           NEMBO_T_ITER_PROCEDIMENTO_OGGE ITPO,                                                                            \n"
        + "           NEMBO_D_ESITO DE,                                                                                                 \n"
        + "           NEMBO_T_ACCERTAMENTO_SPESE ASP                                                                                    \n"
        + "         WHERE                                                                                                             \n"
        ...
        + "   (SELECT RS.FLAG_INTERVENTO_COMPLETATO FROM NEMBO_T_RENDICONTAZIONE_SPESE RS WHERE RS.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO AND RS.ID_INTERVENTO = I.ID_INTERVENTO) as FLAG_INTERVENTO_COMPLETATO, \n"
        + "   (SELECT RS.NOTE FROM NEMBO_T_RENDICONTAZIONE_SPESE RS WHERE RS.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO AND RS.ID_INTERVENTO = I.ID_INTERVENTO) as NOTE, \n"
        + "   (SELECT SUM(IMPORTO) FROM NEMBO_R_DOC_SPESA_INT_RICEV_PA DSIRP WHERE DSIRP.ID_DOCUMENTO_SPESA = DS.ID_DOCUMENTO_SPESA AND DSIRP.ID_INTERVENTO = I.ID_INTERVENTO) AS IMPORTO_RICEVUTE_PAGAMENTO, "
        + "   L.CODICE_LIVELLO,                                                                                                                                       \n"
        + "   (                                                                                                                  \n"
        + "     SELECT                                                                                                           \n"
        ...
        + "     FROM                                                                                                             \n"
        + "       NEMBO_T_DOCUMENTO_SPESA_FILE DSF                                                                                 \n"
        + "     LEFT JOIN NEMBO_R_DOC_SPESA_PROC_OGG DSPO                                                                          \n"
        + "     ON                                                                                                               \n"
        + "       DSF.ID_DOCUMENTO_SPESA_FILE      = DSPO.ID_DOCUMENTO_SPESA_FILE                                                \n"
        + "       AND DSPO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO                                                    \n"
        + "     LEFT JOIN NEMBO_T_PROCEDIMENTO_OGGETTO PROC_OGG                                                                    \n"
        + "     ON                                                                                                               \n"
        ...
        + "       COUNT(*)                                                                  \n"
        + "     FROM                                                                        \n"
        + "       NEMBO_R_DOC_SPESA_PROC_OGG SPO,                                             \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO ISTANZA,                                       \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO ISTRUTTORIA,                                   \n"
        + "       NEMBO_T_ITER_PROCEDIMENTO_OGGE IPO,                                       \n"
        + "       NEMBO_T_ACCERTAMENTO_SPESE ASP,                                             \n"
    ...
    try
    {
      ...
      if (numRowsUpdated == 0)
      {
        QUERY = " INSERT INTO                                 \n"
            ...
            + "     :IMPORTO_RENDICONTATO,                  \n"
            + "     :ID_DOCUMENTO_SPESA_INTERVEN,           \n"
            + "     SEQ_NEMBO_R_DOC_SPE_INT_PROC_O.NEXTVAL, \n"
            + "     :EXT_ID_UTENTE_AGGIORNAMENTO,           \n"
            + "     SYSDATE                                 \n"
            + "   )                                         \n";
        numRowsUpdated = namedParameterJdbcTemplate.update(QUERY,
    ...
    try
    {
      ...
      if (numRowsUpdated == 0)
      {
        UPDATE = " INSERT                                                                        \n"
            ...
            + "   (                                                                           \n"
            + "     SELECT                                                                    \n"
            + "       SEQ_NEMBO_T_RENDICONTAZIO_SPES.NEXTVAL,                                 \n"
            + "       CONTRIBUTO_RICHIESTO,                                                   \n"
            + "       FLAG_INTERVENTO_COMPLETATO,                                             \n"
            + "       ID_INTERVENTO,                                                          \n"
            + "       ID_PROCEDIMENTO_OGGETTO,                                                \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String UPDATE = " UPDATE                                                                  \n"
        ...
        + "             *                                                           \n"
        + "           FROM                                                          \n"
        + "             NEMBO_W_DETT_INTERV_PROC_OGG WTMP                             \n"
        + "           WHERE                                                         \n"
      ...
      List<Long> idIntervento) throws InternalUnexpectedException
  {
    ...
    String QUERY = " WITH                                                                    \n"
        ...
        + "		  AND PO.CODICE_RAGGRUPPAMENTO = (SELECT CODICE_RAGGRUPPAMENTO FROM NEMBO_T_PROCEDIMENTO_OGGETTO WHERE ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO   )\n"
        ...
        + "                           FROM                                                                                                                  \n"
        + "                           NEMBO_T_PROCEDIMENTO_OGGETTO V1,                                                                                        \n"
        + "                           NEMBO_T_PROCEDIMENTO_OGGETTO V3,                                                                                        \n"
        + "                           NEMBO_T_PROCEDIMENTO V2,                                                                                                \n"
        + "                           NEMBO_T_ITER_PROCEDIMENTO_OGGE IPO,                                                                                   \n"
        + "                           NEMBO_R_DOC_SPESA_INT_PROC_OGG DOC                                                                                      \n"
        + "                           WHERE                                                                                                                 \n"
        ...
        + "       NEMBO_R_DOC_SPESA_PROC_OGG DSPO,                                        \n"
        + "       ISTANZA I,                                                            \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO PROC_OGG                                   \n"
        + "     WHERE                                                                   \n"
        + "       DSF.ID_DOCUMENTO_SPESA    = DS.ID_DOCUMENTO_SPESA                     \n"
        + "       AND DSF.ID_DOCUMENTO_SPESA_FILE   = DSPO.ID_DOCUMENTO_SPESA_FILE      \n"
        + "       AND I.ID_PROCEDIMENTO_OGGETTO = DSPO.ID_PROCEDIMENTO_OGGETTO          \n"
        ...
        + "    DDS.ID_MODALITA_PAGAMENTO = MP.ID_MODALITA_PAGAMENTO ,                                                                                       \n"
        + "    NEMBO_R_DOCUMENTO_SPESA_INTERV DSI                                                                                                           \n"
        + "  LEFT JOIN NEMBO_R_DOC_SPESA_INT_ACC_SPES ACCSP                                                                                                  \n"
        + "  ON                                                                                                                                             \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " UPDATE                                                           \n"
        + "   NEMBO_R_DOC_SPESA_INT_ACC_SPES                                   \n"
        + " SET                                                              \n"
    ...
    try
    {
      ...
      if (numRowsUpdated == 0)
      {
        QUERY = " INSERT INTO                                 \n"
            ...
            + "     :IMPORTO_CALCOLO_CONTRIBUTO,                  \n"
            + "     :ID_DOCUMENTO_SPESA_INTERVEN,           \n"
            + "     SEQ_NEMBO_R_DOC_SPE_INT_ACC_SP.NEXTVAL, \n"
            + "     :EXT_ID_UTENTE_AGGIORNAMENTO,           \n"
            + "     SYSDATE                                 \n"
            + "   )                                         \n";
        numRowsUpdated = namedParameterJdbcTemplate.update(QUERY,
      ...
      throws InternalUnexpectedException
  {
    ...
    String UPDATE = " UPDATE                                                                  \n"
        ...
        + "   FROM                                                                  \n"
        + "     NEMBO_R_DOC_SPESA_INT_ACC_SPES DSIPO,                                 \n"
        + "     NEMBO_R_DOCUMENTO_SPESA_INTERV DSI,                                  \n"
        + "     PERCENTUALE P                                                       \n"
        + "   WHERE                                                                 \n"
        + "     DSIPO.ID_DOCUMENTO_SPESA_INTERVEN = DSI.ID_DOCUMENTO_SPESA_INTERVEN \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String DELETE = " INSERT                                                   \n"
        ...
        + "   (                                                      \n"
        + "     SELECT                                               \n"
        + "       SEQ_NEMBO_R_DOC_SPESA_PROC_OGG.NEXTVAL,              \n"
