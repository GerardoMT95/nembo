...
public class BaseDAO
{
  ...
  {
    final String QUERY = " SELECT 1 FROM NEMBO_D_BANDO WHERE ID_BANDO = ( SELECT A.ID_BANDO FROM NEMBO_T_PROCEDIMENTO A WHERE A.ID_PROCEDIMENTO = :ID_PROCEDIMENTO )FOR UPDATE ";
  ...
  {
    final String QUERY = " SELECT 1 FROM NEMBO_T_PROCEDIMENTO WHERE ID_PROCEDIMENTO = :ID_PROCEDIMENTO FOR UPDATE ";
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
    mapParameterSource.addValue("ID_PROCEDIMENTO", idProcedimento,
        Types.NUMERIC);
    namedParameterJdbcTemplate.queryForLong(QUERY, mapParameterSource);
  ...
  {
    final String QUERY = " SELECT ID_PROCEDIMENTO FROM NEMBO_T_PROCEDIMENTO WHERE ID_PROCEDIMENTO = (SELECT PO.ID_PROCEDIMENTO FROM NEMBO_T_PROCEDIMENTO_OGGETTO PO WHERE PO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO) FOR UPDATE ";
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
  ...
  {
    final String QUERY = " SELECT ID_PROCEDIMENTO_OGGETTO FROM NEMBO_T_PROCEDIMENTO_OGGETTO WHERE ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO FOR UPDATE ";
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
    mapParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO",
        idProcedimentoOggetto, Types.NUMERIC);
    return namedParameterJdbcTemplate.queryForLong(QUERY,
      ...
      throws InternalUnexpectedException
  {
    ...
    final String ID = nomeTabella.replace("NEMBO_D", "ID");
      ...
      throws InternalUnexpectedException
  {
    ...
    final String UPDATE = "UPDATE NEMBO_T_PROCEDIM_OGGETTO_QUADR               \n"
        + " SET                               \n"
        + "   EXT_ID_UTENTE_AGGIORNAMENTO = :EXT_ID_UTENTE_AGGIORNAMENTO,   \n"
        + "   DATA_ULTIMO_AGGIORNAMENTO = SYSDATE,              \n"
        + "   FLAG_COMPILATO = 'S'                      \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = "INSERT INTO NEMBO_T_PROCEDIM_OGGETTO_QUADR    \n"
    ...
    try
    {
      mapParameterSource.addValue("ID_PROCEDIM_OGGETTO_QUADRO",
          getNextSequenceValue("SEQ_NEMBO_T_PROCEDIM_OGGET_QUA"),
          Types.NUMERIC);
      mapParameterSource.addValue("EXT_ID_UTENTE_AGGIORNAMENTO",
          extIdUtenteAggiornamento, Types.NUMERIC);
      mapParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO",
    ...
    if (msg != null && msg.indexOf("ORA-") >= 0)
    {
      logger.info(
          "[BaseDAO::safeMessaggio] Il pl/sql ha ritornato un messaggio contenente informazioni non visualizzabili all'utente, messaggio: "
              + msg);
      msg = "Si � verificato un errore di sistema";
    }
    return msg;
  }
      ...
      throws InternalUnexpectedException
  {
    ...
    mapSqlParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO",
        idProcedimentoOggetto, Types.NUMERIC);
    mapSqlParameterSource.addValue("ID_PROCEDIMENTO_NEMBOPRATICHE",
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      mapParameterSource.addValue("ID_PROCEDIMENTO_NEMBO",
      ...
      throws InternalUnexpectedException
  {
    ...
    {
      logger.error(
          THIS_METHOD + " idParametro � null! NullPointerException in arrivo!");
    }
    StringBuilder queryBuilder = new StringBuilder(
      ...
      throws InternalUnexpectedException
  {
    ...
    {
      logger.error(
          THIS_METHOD + " codcdu � null! NullPointerException in arrivo!");
    }
    StringBuilder queryBuilder = new StringBuilder(
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                  	\n"
        + "  *                                    									\n"
        + " FROM                                                    				\n"
        + "  NEMBO_T_PROCEDIM_OGGETTO_QUADR                          				\n"
        + " WHERE                                                   				\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String UPDATE = "UPDATE NEMBO_T_PROCEDIMENTO               			\n"
        + " SET                               								\n"
        + "   EXT_ID_UTENTE_AGGIORNAMENTO = :EXT_ID_UTENTE_AGGIORNAMENTO,   \n"
        + "   DATA_ULTIMO_AGGIORNAMENTO = SYSDATE,              			\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String UPDATE = "UPDATE NEMBO_T_PROCEDIMENTO_OGGETTO               				  	\n"
        + " SET                               								              	\n"
        + "   EXT_ID_UTENTE_AGGIORNAMENTO = :EXT_ID_UTENTE_AGGIORNAMENTO,   				\n"
        + "   ID_ESITO = :ID_ESITO                      					          		\n"
        + " WHERE                               							              	\n"
                ...
                throws SQLException, DataAccessException
            {
              ...
              while (rs.next())
              {
                ...
                { rs.getString("OBJECT_NAME"), rs.getString("STATUS"),
                    null /*
                          * Verr� riempito dalla controller con il nome
...
//  }
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                 \n"
        ...
        + "   (SELECT B1.FLAG_RENDICONTAZIONE_DOC_SPESA FROM NEMBO_D_BANDO B1 WHERE B1.ID_BANDO = P.ID_BANDO ) AS FLAG_RENDICONTAZIONE_DOC_SPESA,       								\n"
        + "   (SELECT TL.CODICE FROM NEMBO_D_TIPO_LIVELLO TL, NEMBO_D_BANDO B1 WHERE B1.ID_BANDO = P.ID_BANDO AND B1.ID_TIPO_LIVELLO = TL.ID_TIPO_LIVELLO ) AS COD_TIPO_LIVELLO,       	\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = "  SELECT                                                \n"
        ...
        + "         NEMBO_R_QUADRO_OGGETTO_AZIONE QOA,                              \n"
        + "         NEMBO_D_AZIONE A,                                               \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                            \n"
        ...
        + "       B.HELP_CDU                                  \n"
        + "     FROM                                          \n"
        + "       NEMBO_R_QUADRO_OGGETTO_AZIONE B               \n"
        + "     WHERE                                         \n"
    ...
    try
    {
      ...
      mapParameterSource.addValue("ID_QUADRO_OGGETTO",
          NemboUtils.NUMBERS.nvl(idQuadroOggetto, 0), Types.NUMERIC);
      return namedParameterJdbcTemplate.query(QUERY, mapParameterSource,
          new ResultSetExtractor<String>()
          {
            @Override
      ...
      throws InternalUnexpectedException
  {
    ...
    mapSqlParameterSource
        .addValue(
            "DESCRIZIONE_COMUNE", "%" + NemboUtils.STRING
  ...
  public Integer getLasDichiarazioneConsistenza(long idAzienda)
      throws InternalUnexpectedException
  {
    ...
    StringBuilder queryBuff = new StringBuilder(
        " SELECT PCK_NEMBO_UTILITY.ReturnDichConsistenza(:ID_AZIENDA, NULL) AS ID FROM DUAL \n");
  ...
  {
    String THIS_METHOD = "[" + THIS_CLASS + "::getParametriBandoOggetto]";
    if (logger.isDebugEnabled())
    {
      logger.debug(THIS_METHOD + " BEGIN.");
    }
    StringBuilder query = new StringBuilder();
    query.append(" SELECT CODICE, VALORE FROM NEMBO_R_PARAMETRO_BANDO_OGGETT P  WHERE  P.ID_BANDO_OGGETTO = :ID_BANDO_OGGETTO AND P.CODICE IN (");
    boolean needComma = false;
    try
    {
      int len = paramNames.length;
  ...
  {
    String THIS_METHOD = "getInformazioniBandoByIdProcOgg";
    String SELECT = "";
    if (logger.isDebugEnabled())
    {
      logger.debug("[" + THIS_CLASS + ":: " + THIS_METHOD + "] BEGIN.");
    ...
    try
    {
      SELECT = " SELECT                                                               \n"
          ...
          + "   C.ID_TIPO_LIVELLO = B.ID_TIPO_LIVELLO                              \n"
          + "   AND D.ID_BANDO(+) = B.ID_BANDO		                               \n"
          + "   AND B.ID_BANDO = (SELECT W.ID_BANDO FROM NEMBO_T_PROCEDIMENTO W, NEMBO_T_PROCEDIMENTO_OGGETTO WE WHERE W.ID_PROCEDIMENTO = WE.ID_PROCEDIMENTO AND WE.ID_PROCEDIMENTO_OGGETTO=:ID_PROCEDIMENTO_OGGETTO)                                         \n";

      MapSqlParameterSource parameterSource = new MapSqlParameterSource();
      parameterSource.addValue("ID_PROCEDIMENTO_OGGETTO", idProcOggetto, Types.NUMERIC);

      return namedParameterJdbcTemplate.query(SELECT, parameterSource, new ResultSetExtractor<BandoDTO>()
      {
        @Override
        public BandoDTO extractData(ResultSet rs) throws SQLException, DataAccessException
        {
          BandoDTO bando = new BandoDTO();
          while (rs.next())
          {
            ...
            bando.setIdBandoMaster(rs.getLong("ID_BANDO_MASTER"));
            bando.setIdTipoLivello(rs.getLong("ID_TIPO_LIVELLO"));
            bando.setFlagTitolaritaRegionale(rs.getString("FLAG_TITOLARITA_REGIONALE"));
            bando.setFlagDomandaMultipla(rs.getString("FLAG_DOMANDA_MULTIPLA"));
            bando.setDenominazione(rs.getString("DENOMINAZIONE"));
            bando.setDescrTipoBando(rs.getString("TIPOLOGIA"));
            bando.setAnnoCampagna(rs.getString("ANNO_CAMPAGNA"));
            bando.setCodiceTipoBando(rs.getString("COD_TIPOLOGIA"));
            bando.setDescrizioneFiltro(rs.getString("DESCRIZIONE_FILTRO"));
            bando.setIstruzioneSqlFiltro(rs.getString("ISTRUZIONE_SQL_FILTRO"));
            bando.setReferenteBando(rs.getString("REFERENTE_BANDO"));
            bando.setEmailReferenteBando(rs.getString("EMAIL_REFERENTE_BANDO"));
            bando.setFlagRibassoInterventi(rs.getString("FLAG_RIBASSO_INTERVENTI"));
            bando.setDenominazione(rs.getString("DENOMINAZIONE"));
            bando.setFlagMaster(flagMaster);
            if (flagMaster.equals("N"))
            {
