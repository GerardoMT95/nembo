    ...
    extends MessaggioBase
{
  ...
  /**
   * Recupera il valore della propriet� testoMessaggio.
   * 
  ...
  /**
   * Imposta il valore della propriet� testoMessaggio.
   * 
   * @param value
  ...
  /**
   * Recupera il valore della propriet� utenteAggiornamento.
   * 
  ...
  /**
   * Imposta il valore della propriet� utenteAggiornamento.
   * 
   * @param value
