...
import it.csi.nembo.nembopratiche.dto.procedimentooggetto.quadrodinamico.DatiComuniElemQuadroDTO;
...
public class QuadroDinamicoDAO extends BaseDAO
{
   ...
   *          Se idProcedimentoOggetto � valorizzato allora leggo i dati del
          ...
          new ResultSetExtractor<QuadroDinamicoDTO>()
          {
                ...
                throws SQLException, DataAccessException
            {
              ...
              while (rs.next())
              {
                ...
                {
                  /*
                   * Se idProcedimentoOggetto � valorizzato allora leggo i dati
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = " INSERT                           \n"
        + " INTO                             \n"
        + "   NEMBO_T_DATI_COMUNI_ELEM_QUADR  \n"
        + "   (                              \n"
        + "     ID_DATI_COMUNI_ELEM_QUADRO,  \n"
    ...
    final long idDatiComuniElemQuadro = getNextSequenceValue(
        NemboConstants.SQL.SEQUENCE.NEMBO_T_DATI_COMU_ELEM_QUA);
    try
    {
      ...
      Map<Long, String[]> mapValues) throws InternalUnexpectedException
  {
    ...
    final String INSERT = " INSERT                                      \n"
        ...
        + "     :VALORE_ELEMENTO,                       \n"
        + "     :ID_ELEMENTO_QUADRO,                    \n"
        + "     SEQ_NEMBO_T_DATO_ELEMENTO_QUAD.NEXTVAL, \n"
        + "     :ID_DATI_COMUNI_ELEM_QUADRO             \n"
        + "   )                                         \n"
