...
import it.csi.nembo.nembopratiche.dto.procedimentooggetto.interventi.RigaInserimentoMultiploInterventiDTO;
		...
		) throws InternalUnexpectedException
{
    ...
    String QUERY = "  SELECT                                                                       \n"
        ...
        if(idDannoAtm != null)
        {
        		...
        		"				FROM    																		\r\n" + 
        		"    				NEMBO_R_DANNO_ATM_INTERVENTO DAIN2,											\r\n" + 
        		"    				NEMBO_T_INTERVENTO I2,														\r\n" + 
        		"    				NEMBO_T_DANNO_ATM DA2														\r\n" + 
        		"				WHERE																			\r\n" + 
      ...
      throws InternalUnexpectedException
  {
    ...
    long idIntervento = getNextSequenceValue(
        NemboConstants.SQL.SEQUENCE.NEMBO_T_INTERVENTO);
    try
    {
      ...
      throws InternalUnexpectedException
  {
    ...
    long idDettIntervProcOgg = getNextSequenceValue(
        NemboConstants.SQL.SEQUENCE.NEMBO_W_DETT_INTERV_PROC_OGG);
    try
    {
      ...
      mapParameterSource.addValue("FLAG_TIPO_OPERAZIONE",
          NemboConstants.INTERVENTI.TIPO_OPERAZIONE_INSERIMENTO,
          Types.VARCHAR);
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = " INSERT                           \n"
        + " INTO                             \n"
        + "   NEMBO_R_DETT_INTE_PROC_OGG_MIS \n"
        + "   (                              \n"
        + "     ID_DETT_INTERV_PROC_OGG,     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                                \n"
        ...
        + "   NEMBO_R_DETT_INTERV_MISURAZION DIM,                                                  \n"
        + "   NEMBO_R_MISURAZIONE_INTERVENTO MI,                                                    \n"
        + "   NEMBO_D_UNITA_MISURA UM,                                                              \n"
        + "   NEMBO_R_LIV_BANDO_INTERVENTO LBI                                                      \n"
        + " WHERE                                                                                 \n"
        ...
        + "   NEMBO_R_DETT_INTE_PROC_OGG_MIS DIPOM,                                               \n"
        + "   NEMBO_R_MISURAZIONE_INTERVENTO MI,                                                    \n"
        + "   NEMBO_D_UNITA_MISURA UM,                                                              \n"
        + "   NEMBO_R_LIV_BANDO_INTERVENTO LBI                                                      \n"
        + " WHERE                                                                                 \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY_INTERVENTI = " SELECT                                                                                \n"
        ...
        + "           TP.DENOMINAZIONE                                                                                                                       \n"
        + "         FROM                                                                                                                                     \n"
        + "           NEMBO_T_PARTECIPANTE TP,                                                                                                                 \n"
        + "           NEMBO_T_DATI_PROCEDIMENTO TDP                                                                                                            \n"
        + "         WHERE                                                                                                                                    \n"
        ...
        + "   NEMBO_R_LIV_BANDO_INTERVENTO LBI,                                                     \n"
        + "   NEMBO_D_LIVELLO LIV,			                                                      \n"
        + "   NEMBO_T_PROCEDIMENTO PROC,		                                                      \n"
        + "   NEMBO_D_CATEGORIA_INTERVENTO CI,                                                    \n"
        
        + "   NEMBO_R_DANNO_ATM_INTERVENTO DAIN,                                                  \n"
        + "   NEMBO_T_DANNO_ATM DA,                                                       		  \n"
        + "   NEMBO_D_DANNO DD                                                       		  \n"
        + " WHERE                                                                                 \n"
        + "   PO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO                               \n"
    ...
    final String QUERY_INVESTIMENTI = " SELECT                                                                                \n"
        ...
        + "   PROGRESSIVO ASC NULLS LAST,                                                         \n"
        + "   ID_DETT_INTERV_PROC_OGG ASC                                                         \n";
    final boolean isInvestimenti = NemboConstants.FLAGS.SI
                    ...
                    || lastIdIntervento != idIntervento)
                {
                  ...
                  if (!isInvestimenti)
                  {
                    ...
                    rigaDTO.setInterventoModificabileASaldo(
                        !NemboConstants.FLAGS.SI.equals(
                            rs.getString("FLAG_GESTIONE_COSTO_UNITARIO")) &&
                            NemboConstants.INTERVENTI.LOCALIZZAZIONE.PARTICELLE_AZIENDALI_IMPIANTI_BOSCHIVI != rs
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                                \n"
        ...
        + "   NEMBO_T_DETTAGLIO_INTERVENTO DI,                                                      \n"
        + "   NEMBO_D_DESCRIZIONE_INTERVENTO DESCINT,                                               \n"
        + "   NEMBO_T_LOCALIZZAZIONE_INTERV LI,                                                     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = " INSERT                                                        \n"
        ...
        + "   (                                                           \n"
        + "     SELECT                                                    \n"
        + "       SEQ_NEMBO_W_LOCAL_INTE_PROC_OG.NEXTVAL,                 \n"
        + "       DIPO.ID_DETT_INTERV_PROC_OGG,                           \n"
        + "       :ISTAT                                                  \n"
        + "     FROM                                                      \n"
        + "       NEMBO_W_DETT_INTERV_PROC_OGG DIPO                         \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = " INSERT                                                        \n"
        + " INTO                                                          \n"
        + "   NEMBO_W_FILE_ALL_INTE_PROC_OGG                              \n"
        + "   (                                                           \n"
        + "     ID_DETT_INTERV_PROC_OGG,                                  \n"
        ...
        + "     FROM                                                      \n"
        + "       NEMBO_R_FILE_ALLEGATI_DETT_INT FADI                     \n"
        + "     WHERE                                                     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    mapParameterSource.addValue("ID_REGIONE",
        NemboConstants.GENERIC.ID_REGIONE_BASILICATA, Types.VARCHAR);
    try
    {
      return (Map<String, Map<String, String>>) namedParameterJdbcTemplate
          .query(QUERY, mapParameterSource,
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT =  " INSERT INTO NEMBO_W_DETT_INTERV_PROC_OGG (                        \n"
			    		 + "         ID_DETT_INTERV_PROC_OGG,                                  \n"
			    		 + "         ID_PROCEDIMENTO_OGGETTO,                                  \n"
			    		 + "         ID_INTERVENTO,                                            \n"
			    		 + "         IMPORTO_INVESTIMENTO,                                     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      mapParameterSource.addValue("FLAG_MODIFICA",
          NemboConstants.INTERVENTI.TIPO_OPERAZIONE_MODIFICA, Types.VARCHAR);
      mapParameterSource.addValue("CUAA_BENEFICIARIO",
          intervento.getCuaaPartecipante(), Types.VARCHAR);
      mapParameterSource.addValue("IMPORTO_UNITARIO",
          intervento.getImportoUnitario(), Types.NUMERIC);
      ...
      throws InternalUnexpectedException
  {
    ...
    StringBuilder queryBuilder = new StringBuilder(
        " SELECT                                                                                               \n"
            ...
            + "     FROM                                                                                             \n"
            + "       NEMBO_T_PROCEDIMENTO_OGGETTO PO,                                                                 \n"
            + "       NEMBO_T_PROCEDIMENTO_AZIENDA PAZ                                                                 \n"
            + "     WHERE                                                                                            \n"
            + "       PO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO                                          \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    StringBuilder insertBuilder = new StringBuilder(
        " INSERT                                                                  \n"
            ...
            + "     WHERE                                                               \n"
            + "       CU.ID_DICHIARAZIONE_CONSISTENZA = DC.ID_DICHIARAZIONE_CONSISTENZA \n"
            + "       AND DC.ID_PROCEDIMENTO = :ID_PROCEDIMENTO_NEMBOPRATICHE                     \n"
            + "       AND DC.ESCLUSO         = 'N'                                      \n"
            + "       AND PO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO         \n"
            + "       AND DC.ID_AZIENDA = PA.EXT_ID_AZIENDA                             \n"
            + "       AND PA.DATA_FINE IS NULL                                          \n"
    ...
    try
    {
      mapParameterSource.addValue("ID_DETT_INTERV_PROC_OGG",
          idDettIntervProcOgg, Types.NUMERIC);
      mapParameterSource.addValue("ID_PROCEDIMENTO_NEMBOPRATICHE",
          idProcedimentoAgricoltura, Types.NUMERIC);
      mapParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO",
          idProcedimentoOggetto, Types.NUMERIC);
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " WITH                                                                                      \n"
        ...
        + "     FROM                                                                                  \n"
        + "       NEMBO_W_DETT_INTERV_PROC_OGG DIPO,                                                    \n"
        + "       NEMBO_W_FILE_ALL_INTE_PROC_OGG FAIPO                                                \n"
        + "     WHERE                                                                                 \n"
        + "       DIPO.ID_INTERVENTO               = :ID_INTERVENTO                                   \n"
        + "       AND DIPO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO                         \n"
        ...
        + " FROM                                                                                      \n"
        + "   FILES F,                                                                                \n"
        + "   NEMBO_T_FILE_ALLEGATI_INTERVEN FAI                                                      \n"
        + " WHERE                                                                                     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String UPDATE = " INSERT                            \n"
        + " INTO                              \n"
        + "   NEMBO_T_FILE_ALLEGATI_INTERVEN  \n"
        + "   (                               \n"
        + "     ID_FILE_ALLEGATI_INTERVENTO,  \n"
        + "     NOME_LOGICO,                  \n"
        + "     NOME_FISICO,                  \n"
    ...
    long idFileAllegatiIntervento = getNextSequenceValue(
        NemboConstants.SQL.SEQUENCE.NEMBO_T_FILE_ALLEGATI_INTERVENTO);
    try
    {
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                  \n"
        ...
        + " FROM                                                    \n"
        + "   NEMBO_T_PROCEDIMENTO_OGGETTO PO,                        \n"
        + "   NEMBO_T_PROCEDIMENTO P, NEMBO_D_BANDO B                   \n"
        + " WHERE                                                   \n"
        + "   PO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = " UPDATE NEMBO_T_PROCEDIMENTO_OGGETTO SET PERCENTUALE_RIBASSO_INTERVENTI=:PERCENTUALE WHERE ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO ";
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " WITH                                                                                  \n"
        ...
        + "       TAS.*                                                                           \n"
        + "     FROM                                                                              \n"
        + "       NEMBO_T_ACCERTAMENTO_SPESE TAS ,                                                  \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO PO_ORIG,                                             \n"
        + "       NEMBO_T_PROCEDIMENTO_OGGETTO PO,                                                  \n"
        + "       NEMBO_D_ESITO E,                                                                  \n"
        + "       NEMBO_T_ITER_PROCEDIMENTO_OGGE IPO                                              \n"
        ...
        + "       DECODE(COUNT(*),0,'N','S')                                                      \n"
        + "     FROM                                                                              \n"
        + "       NEMBO_R_DOCUMENTO_SPESA_INTERV DSI2                                             \n"
        + "     WHERE                                                                             \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = " INSERT                                    \n"
        ...
        + "   (                                       \n"
        + "     :FLAG_INTERVENTO_COMPLETATO,          \n"
        + "     SEQ_NEMBO_T_ACCERTAMENTO_SPESE.NEXTVAL, \n"
        + "     :ID_INTERVENTO,                       \n"
        + "     :ID_PROCEDIMENTO_OGGETTO,             \n"
        + "     :IMPORTO_ACCERTATO,                   \n"
        + "     :IMPORTO_CALCOLO_CONTRIBUTO,          \n"
      ...
      long idProcedimentoOggetto) throws InternalUnexpectedException
  {
    ...
    String QUERY = " SELECT                                                       \n"
        ...
        + "       NEMBO_R_ATTIVITA_PARTECIPANTE AP                         \n"
        + "     WHERE                                                    \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                       \n"
        ...
        + "        FROM                                                                  \n"
        + "          NEMBO_T_RENDICONTAZIONE_SPESE B1                                      \n"
        + "        WHERE                                                                 \n"
        ...
        + "        FROM                                                                  \n"
        + "          NEMBO_T_RENDICONTAZIONE_SPESE B1,                                     \n"
        + "          NEMBO_R_DOC_SPESA_INT_PROC_OGG C1,                                    \n"
        + "          NEMBO_R_DOCUMENTO_SPESA_INTERV D1                                   \n"
        + "        WHERE                                                                 \n"
        + "          B1.ID_INTERVENTO = A.ID_INTERVENTO                                  \n"
        ...
        + "  FROM                                                                        \n"
        + "    NEMBO_T_INTERVENTO A,                                                       \n"
        + "    NEMBO_D_DESCRIZIONE_INTERVENTO DESCINT,                                     \n"
        + "    NEMBO_T_DETTAGLIO_INTERVENTO B,                                             \n"
        + "    NEMBO_R_LIV_BANDO_INTERVENTO BI,                                             \n"
        + "    NEMBO_R_LIVELLO_INTERVENTO C,                                               \n"
        + "         NEMBO_R_AGGREGAZIONE_INTERVENT AI,                                     \n"
        + "         NEMBO_D_TIPO_AGGREGAZIONE TA                                            \n"
        ...
        + "    AND BI.ID_BANDO = (SELECT ID_BANDO FROM NEMBO_T_PROCEDIMENTO WHERE ID_PROCEDIMENTO = A.ID_PROCEDIMENTO)             \n"
        ...
        + "       FROM NEMBO_R_DOCUMENTO_SPESA_INTERV DSI                               \n"
        + "       WHERE "
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = "  SELECT                                                                                     \n"
        ...
        + "         DI.PERCENTUALE_CONTRIBUTO,                                                          \n"
        + "         DI.IMPORTO_CONTRIBUTO,                                                               \n"
        + "         (SELECT DATA_AMMISSIONE FROM NEMBO_R_PROCEDIMENTO_LIVELLO 								\n"
  ...
  public List<DecodificaInterventoDTO> getListInvestimentiPossibili(long idProcedimentoOggetto)
	      throws InternalUnexpectedException
	  {
	    ...
	    {
	      mapParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO", idProcedimentoOggetto, Types.NUMERIC);
	      mapParameterSource.addValue("FLAG_ESCLUDI_CATALOGO", NemboConstants.FLAGS.SI, Types.VARCHAR);
  ...
  public void updateFlagAssociatoAltraMisura(long idDettIntervProcOgg, String flagAssociatoAltraMisura)
	...
	public int inserisciDannoAtmIntervento(long idProcedimentoOggetto, long idIntervento, DanniDTO danno) throws InternalUnexpectedException
	{
	    ...
	    final String INSERT =  
	    		"INSERT INTO NEMBO_R_DANNO_ATM_INTERVENTO					\r\n" + 
	    		"    (														\r\n" + 
	    		"        ID_INTERVENTO,										\r\n" + 
	    		"        ID_PROCEDIMENTO_OGGETTO,							\r\n" + 
	    		"        PROGRESSIVO										\r\n" + 
		...
		throws InternalUnexpectedException
	{
	    ...
	    final String QUERY = 
	    	...
	    	"        AND DC.ID_PROCEDIMENTO = :ID_PROCEDIMENTO_NEMBO			\r\n" + 
	    	"    ORDER BY 														\r\n" + 
	    	"        SVU.ID_UTE													\r\n" + 
	    	")																	\r\n" + 
	    	"WHERE ROWNUM < 2													\r\n" + 
	    ...
	    try
	    {
	      ...
	      mapParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO", idProcedimentoOggetto, Types.NUMERIC);
	      mapParameterSource.addValue("ID_PROCEDIMENTO_NEMBO", idProcedimentoAgricoltura, Types.NUMERIC);
	    ...
	    catch (Throwable t)
	    {
	      InternalUnexpectedException e = new InternalUnexpectedException(t,
	          ...
	          {
	              new LogParameter("ID_PROCEDIMENTO_OGGETTO", idProcedimentoOggetto),
	              new LogParameter("ID_PROCEDIMENTO_NEMBO", idProcedimentoAgricoltura)
	          },
	          new LogVariable[]
	          {}, QUERY, mapParameterSource);
	      logInternalUnexpectedException(e, THIS_METHOD);
	...
	public void updateWDettIntervProcOgg(long idDettIntervProcOgg, String flagCanale, String flagOpereDiPresa, String flagCondotta) throws InternalUnexpectedException{
	    ...
	    final String UPDATE =  " UPDATE NEMBO_W_DETT_INTERV_PROC_OGG                    \n"
				    		 + " SET                                                    \n"
	...
	public Long findIdTDettIntervProcOgg(long idProcedimentoOggetto,
		      long idIntervento) throws InternalUnexpectedException
		  {
		    ...
		    final String QUERY =   " SELECT                                                      \n"
					    		 ...
					    		 + " FROM                                                        \n"
					    		 + "     NEMBO_T_DETTAGLIO_INTERVENTO DIPO                       \n"
					    		 + " WHERE                                                       \n"
					    		 + "     DIPO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO \n"
					    		 + "     AND DIPO.ID_INTERVENTO = :ID_INTERVENTO                 \n";
		    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
	...
	public List<RigaElencoInterventi> getListInterventiPrevenzioneTemporanei(long idProcedimentoOggetto) throws InternalUnexpectedException
	{
	    ...
	    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
	    mapParameterSource.addValue("ID_PROCEDIMENTO_OGGETTO", idProcedimentoOggetto, Types.NUMERIC);
	    mapParameterSource.addValue("CODICE_IDENTIFICATIVO", NemboConstants.PUNTEGGI.CODICE_INTERVENTI_PREVENZIONE, Types.VARCHAR);
	    try
	    {
	    ...
	    catch (Throwable t)
	    {
	      InternalUnexpectedException e = new InternalUnexpectedException(t,
	          ...
	          {
	              new LogParameter("ID_PROCEDIMENTO_OGGETTO", idProcedimentoOggetto),
	              new LogParameter("CODICE_IDENTIFICATIVO", NemboConstants.PUNTEGGI.CODICE_INTERVENTI_PREVENZIONE),
	          },
	          new LogVariable[]
	          {
	          }, QUERY, mapParameterSource);
	...
	public List<RigaElencoInterventi> getListInterventiPrevenzioneConsolidati(long idProcedimentoOggetto) throws InternalUnexpectedException
	{
		...
		String QUERY = 
				...
				"     NEMBO_D_DESCRIZIONE_INTERVENTO DI,                               	\r\n" + 
				"     NEMBO_T_INTERVENTO I,                                            	\r\n" + 
				"     NEMBO_T_DETTAGLIO_INTERVENTO DETTIN,                             	\r\n" + 
				"     NEMBO_R_DETT_INTERV_MISURAZION DIM,                              	\r\n" + 
				"     NEMBO_R_MISURAZIONE_INTERVENTO MI,								\r\n" + 
				"     NEMBO_T_PROCEDIMENTO_OGGETTO PO									\r\n" + 
				" WHERE                                                                	\r\n" + 
	...
	public String getCodiceIdentificativoIntervento(long idIntervento) throws InternalUnexpectedException
	{
		...
		String query = " SELECT                                                            \n"
					 ...
					 + " FROM                                                              \n"
					 + "     NEMBO_D_DESCRIZIONE_INTERVENTO D,                             \n"
					 + "     NEMBO_T_INTERVENTO I                                          \n"
					 + " WHERE                                                             \n"
					 + "     I.ID_INTERVENTO = :ID_INTERVENTO                              \n"
	...
	public int updateFlagTipoOperazioneInterventoW(long idIntervento, String flagTipoOperazione) throws InternalUnexpectedException
	{
	    ...
	    final String UPDATE = " UPDATE NEMBO_W_DETT_INTERV_PROC_OGG SET FLAG_TIPO_OPERAZIONE =:FLAG_TIPO_OPERAZIONE WHERE ID_INTERVENTO = :ID_INTERVENTO ";
