...
import it.csi.csi.util.IDProcedimento;
...
import it.csi.nembo.nembopratiche.dto.nuovoprocedimento.AzioneDTO;
...
import it.csi.nembo.nembopratiche.dto.nuovoprocedimento.QuadroDTO;
...
public class NuovoProcedimentoDAO extends BaseDAO
{
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      SELECT = " SELECT                                                                   \n"
          ...
          + "  NEMBO_R_LEGAME_GRUPPO_OGGETTO E,                                          \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      SELECT = " SELECT                                                                   \n"
          ...
          + "  AND SYSDATE BETWEEN A.DATA_INIZIO AND NVL(A.DATA_FINE,SYSDATE)          \n"
          + "  AND D.FLAG_ATTIVO = 'S'                                                 \n"
          + " ORDER BY A.DATA_FINE, A.DENOMINAZIONE, C.ORDINAMENTO, F.ORDINE, E.ORDINE \n";
      ...
      return namedParameterJdbcTemplate.query(SELECT,
          parameterSource, new ResultSetExtractor<List<BandoDTO>>()
          {
            @Override
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      SELECT = " SELECT                                             \n"
          ...
          + "   NEMBO_D_GRUPPO_OGGETTO D,                        	 \n"
          + "   NEMBO_R_QUADRO_OGGETTO E,                          \n"
          + "   NEMBO_D_QUADRO F,                                  \n"
          + "   NEMBO_R_QUADRO_OGGETTO_AZIONE G,                   \n"
          + "   NEMBO_D_AZIONE H                                   \n"
          + " WHERE                                              \n"
          + "   A.ID_BANDO = :ID_BANDO                           \n"
          + "   A.FLAG_ATTIVO = 'S'		                         \n"
      ...
      UtenteAbilitazioni utenteAbilitazioni) throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      SELECT.append(" SELECT 								                           \n"
          ...
          + "       C1.DATA_FINE                                               \n"
          + "     FROM                                                         \n"
          + "       NEMBO_T_PROCEDIMENTO B1,                                     \n"
          + "       NEMBO_T_PROCEDIMENTO_OGGETTO C1,                             \n"
          + "       NEMBO_D_STATO_OGGETTO O1,                            		   \n"
          + "       SMRGAA_V_SOGGETTI_COLLEGATI SC1,                          \n"
          + "       NEMBO_T_PROCEDIMENTO_AZIENDA D1                              \n"
          + "     WHERE                                                        \n"
                ...
                throws SQLException, DataAccessException
            {
              ...
              while (rs.next())
              {
                ...
                if (procOggetto == null || procOggetto.trim().length() <= 0)
                {
                  ...
                  azienda
                      .setAzione(NemboConstants.PAGINATION.AZIONI.AGGIUNGI);
                ...
                else
                {
                  ...
                  azienda
                      .setAzione(NemboConstants.PAGINATION.AZIONI.DETTAGLIO);
                  azienda.setTitleHref(
                ...
                else
                {
                  ...
                  azienda.setDataTrasmissione(
                      NemboUtils.DATE.formatDate(dataFine));
                }
      ...
      Long codRaggruppamento) throws InternalUnexpectedException
  {
    ...
    StringBuffer CALL = new StringBuffer(
        "PCK_NEMBO_CONTROLLI.MainControlliGravi");
    if (logger.isDebugEnabled())
    {
      logger.debug("[" + THIS_CLASS + ":: " + THIS_METHOD + "] BEGIN.");
    }
    ...
    try
    {
      ...
      SimpleJdbcCall call = new SimpleJdbcCall(
          (DataSource) appContext.getBean("dataSource"))
              .withCatalogName("PCK_NEMBO_CONTROLLI")
      ...
      boolean forzaAlfanumerico, long idProcedimentoAgricolo) throws InternalUnexpectedException
  {
    ...
    StringBuffer CALL = new StringBuffer(
        "PCK_NEMBO_GESTIONE_PROC_OGGETT.MainCreazione");
    if (logger.isDebugEnabled())
    {
      logger.debug("[" + THIS_CLASS + ":: " + THIS_METHOD + "] BEGIN.");
    }
    try
    {
      ...
      SimpleJdbcCall call = new SimpleJdbcCall(
          (DataSource) appContext.getBean("dataSource"))
              .withCatalogName("PCK_NEMBO_GESTIONE_PROC_OGGETT")
      ...
      long idUtenteLogin) throws InternalUnexpectedException
  {
    ...
    String UPDATE = " INSERT                                                                        \n"
        + " INTO                                                                          \n"
        + "   NEMBO_T_PROCEDIM_AMMINISTRAZIO                                              \n"
        + "   (                                                                           \n"
        ...
        + "   (                                                                           \n"
        + "     SELECT                                                                    \n"
        + "       SEQ_NEMBO_T_PROCEDIM_AMMINISTR.NEXTVAL,                                 \n"
        + "       ID_PROCEDIMENTO,                                                        \n"
        + "       EXT_ID_AMM_COMPETENZA,                                                  \n"
        + "       SYSDATE,                                                                \n"
        + "       DATA_FINE,                                                              \n"
      ...
      long idAzienda) throws InternalUnexpectedException
  {
    ...
    QUERY.append(
        " SELECT                                                                 \n"
            ...
            + " FROM                                                                   \n"
            + "   NEMBO_T_DATI_PROCEDIMENTO DPAZ1,                                       \n"
            + "   NEMBO_T_PROCEDIMENTO_OGGETTO POAZ1,                                    \n"
            + "   NEMBO_T_PROCEDIMENTO PPAZ1,                                            \n"
            + "   NEMBO_T_PROCEDIMENTO_AZIENDA PROCAZAZ1,                                \n"
            + "   NEMBO_R_LEGAME_GRUPPO_OGGETTO LGOAZ1,                                  \n"
            + "   NEMBO_D_OGGETTO OOAZ1,                                                 \n"
            + "   NEMBO_R_PROCEDIMENTO_LIVELLO PL,                                       \n"
            + "   NEMBO_D_LIVELLO DL,                                                    \n"
            + "   NEMBO_T_PROC_DOMANDA_PREC DP                                           \n"
            + " WHERE                                                                  \n"
            ...
            + "   AND EXISTS (SELECT PL2.ID_PROCEDIMENTO FROM NEMBO_R_PROCEDIMENTO_LIVELLO PL2 WHERE  \n"
      ...
      long idBandoVecchio) throws InternalUnexpectedException
  {
    ...
    final String UPDATE = " INSERT                                      		\n"
        ...
        + "   VALUES                                    \n"
        + "   (                                         \n"
        + "     SEQ_NEMBO_T_PROC_DOMANDA_PREC.NEXTVAL,    \n"
        + "     :ID_PROCEDIMENTO,                       \n"
        + "     :ID_AZIENDA,                 			\n"
        + "     :ID_BANDO,                              \n"
        + "     'N'           							\n"
      ...
      throws InternalUnexpectedException
  {
    String THIS_METHOD = "callMainCreazione";
    StringBuffer CALL = new StringBuffer(
        "PCK_NEMBO_UTILITY.WrapperIsGraphicValidation");
    if (logger.isDebugEnabled())
    {
      logger.debug("[" + THIS_CLASS + ":: " + THIS_METHOD + "] BEGIN.");
    }
    try
    {
      Integer idDichConsistenza = getLasDichiarazioneConsistenza(idAzienda);
      ...
      SimpleJdbcCall call = new SimpleJdbcCall(
          (DataSource) appContext.getBean("dataSource"))
              .withCatalogName("PCK_NEMBO_UTILITY")
  ...
  public int updateNoteIterCorrenteByIdprocedimento(long idProcedimento, String note) throws InternalUnexpectedException{
		final String THIS_METHOD = "updateNoteIterCorrenteByIdprocedimento";
	    if (logger.isDebugEnabled())
	    {
	      logger.debug("[" + THIS_CLASS + "." + THIS_METHOD + " BEGIN.");
	    }
	    String UPDATE =    " UPDATE NEMBO_T_ITER_PROCEDIMENTO_OGGE                                 \n"
			    		 + " SET                                                                   \n"
			    		 + "     NOTE = :NOTE                                                      \n"
			    		 + " WHERE                                                                 \n"
