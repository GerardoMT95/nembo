...
public class RicercaDAO extends BaseDAO
{
  ...
  public List<LivelloDTO> getLivelliAttivi(int idProcedimentoAgricolo) throws InternalUnexpectedException
  {
    ...
    final String QUERY = "  SELECT  DISTINCT                                                \n"
        ...
        + "   AND EXISTS (                                                   \n"
        + "       SELECT BO.ID_BANDO_OGGETTO FROM NEMBO_R_BANDO_OGGETTO BO     \n"
  ...
  private String getQueryBandiAttivi(Boolean conEventoCalamitoso, int idProcedimentoAgricolo){
	...
	if(conEventoCalamitoso){
		QUERY_BANDI_ATTIVI = QUERY_BANDI_ATTIVI+",      NEMBO_D_EVENTO_CALAMITOSO EC                                                                  \n";
	}
	...
	QUERY_BANDI_ATTIVI = QUERY_BANDI_ATTIVI+ "   AND L.DATA_INIZIO <= SYSDATE                                  									\n"
					             + "   AND EXISTS (                                                   									\n"
					             + "       SELECT BO2.ID_BANDO_OGGETTO FROM NEMBO_R_BANDO_OGGETTO BO2     								\n"
      ...
      long[] lIdBando) throws InternalUnexpectedException
  {
    ...
    final StringBuffer QUERY = new StringBuffer(
        " SELECT DISTINCT                                 				\n"
            ...
            + "   NEMBO_T_PROCEDIM_AMMINISTRAZIO B,             	\n"
     ...
     long[] lIdAmministrazioni) throws InternalUnexpectedException
  {
    ...
    final StringBuffer QUERY = new StringBuffer(
        "	WITH PROC_BOZZA_BANDI_SCAD AS (          		\n"
            ...
            + " FROM                                            \n"
            + "   NEMBO_D_STATO_OGGETTO A,                        \n"
            + "   NEMBO_T_PROCEDIMENTO B,                         \n"
            + "   NEMBO_D_BANDO DB,                               \n"
            + "   NEMBO_R_LIVELLO_BANDO LB,                       \n"
            + "   NEMBO_T_PROCEDIM_AMMINISTRAZIO PA             \n"
            + " WHERE                                           \n"
      ...
      UtenteAbilitazioni utenteAbilitazioni) throws InternalUnexpectedException
  {
    ...
    QUERY.append(" FROM                                              	\n"
        ...
        + "   NEMBO_T_PROCEDIMENTO B,                                       	\n"
        + "   NEMBO_T_PROCEDIMENTO_OGGETTO C,                               	\n"
        + "   NEMBO_R_LEGAME_GRUPPO_OGGETTO D,                              	\n"
        + "   NEMBO_T_ITER_PROCEDIMENTO_GRUP IPG,                         	\n"
        + "   NEMBO_D_STATO_OGGETTO SO,			                          	\n"
        + "   NEMBO_R_LIVELLO_BANDO LB,                         			  	\n"
        + "   NEMBO_D_ESITO E,                                              	\n"
        + "   NEMBO_T_PROCEDIM_AMMINISTRAZIO PA               			  	\n"
        + " WHERE                                                         	\n"
    ...
    try
    {
      ...
      if (vo.getIstanzaDataA() != null || vo.getIstanzaDataDa() != null)
      {
        SELECT.append("  (SELECT   														         	\n"
            + "				MAX(I2.DATA_INIZIO)    										        	\n"
            + "			FROM     															       	\n"
            + "				NEMBO_T_PROCEDIMENTO_OGGETTO I1,  							          	\n"
            + "				NEMBO_T_ITER_PROCEDIMENTO_OGGE I2           							\n"
            + "			WHERE 	 														          	\n"
      ...
      SELECT.append(
          "    P.ID_PROCEDIMENTO     						             						\n"
              ...
              + "    NEMBO_T_PROCEDIMENTO_AZIENDA PA,                          						\n"
              + "    NEMBO_T_PROCEDIM_AMMINISTRAZIO AM,                      						\n"
      ...
      {
        SELECT.append(" NEMBO_D_ESITO DE,  										\n");
      }
        ...
        while (it.hasNext())
        {
          ...
          else
          {
            SELECT.append(" " + sep + "  EXISTS ( "
                ...
                + "	FROM "
                + "		NEMBO_R_LEGAME_GRUPPO_OGGETTO LGO2, "
                + "		NEMBO_T_ITER_PROCEDIMENTO_GRUP IPG2, "
                + "		NEMBO_T_PROCEDIMENTO_OGGETTO PO2 "
                + "	WHERE "
          ...
          && vo.getVctFlagEstrazione().size() > 0)
      {
        ...
        SELECT.append(" EXISTS ( "
            ...
            + "	FROM "
            + "		NEMBO_T_PROCEDIMENTO_ESTRATTO A, "
            + "		NEMBO_T_ESTRAZIONE_CAMPIONE B "
            + "	WHERE "
          ...
          && vo.getVctFlagEstrazioneExPost().size() > 0)
      {
        ...
        SELECT.append(" EXISTS ( "
            ...
            + "	FROM "
            + "		NEMBO_T_PROCEDIMENTO_ESTR_EXPO A, "
            + "		NEMBO_T_ESTRAZIONE_CAMPIONE B "
            + "	WHERE "
            + "		A.ID_ESTRAZIONE_CAMPIONE = B.ID_ESTRAZIONE_CAMPIONE "
            + "		AND B.FLAG_APPROVATA = 'S' "
       ...
       * gal aggiungiamo una NOT IN con gli id_bando a cui non pu� accedere
       */
      ...
      if (!GenericValidator.isBlankOrNull(vo.getDenominazione()))
      {
        parameterSource.addValue("DENOMINAZIONE",
            "%" + NemboUtils.STRING.normalizeString(
          ...
          parameterSource, new ResultSetExtractor<List<Long>>()
          {
                ...
                throws SQLException, DataAccessException
            {
              ...
              while (rs.next())
              {
                ...
                /*
                 * controllo se ho gi� inserito in lista questo id non mi serve
                 * sapere quanti sono, solo se sono uno o pi� di uno quindi
    ...
    try
    {
      SELECT.append(
          " SELECT                                      		 							\n"
              ...
              + "   '" + NemboConstants.PAGINATION.AZIONI.DETTAGLIO
              + "' AS AZIONE,                     	\n"
              + "   'Visualizza Dettaglio' AS TITLE_HREF,                           			  	\n"
              + "   '../cunembo129/index_' || PO.ID_PROCEDIMENTO || '.do' AS AZIONE_HREF 		  	\n"
              + "  FROM                                                     						\n"
              + "    NEMBO_T_PROCEDIMENTO P,                                   						\n"
              + "    NEMBO_T_PROCEDIMENTO_OGGETTO PO,                          						\n"
              + "    NEMBO_T_PROCEDIMENTO_AZIENDA PA,                          						\n"
          ...
          parameterSource, new ResultSetExtractor<List<ProcedimentoOggettoVO>>()
          {
                ...
                throws SQLException, DataAccessException
            {
              ...
              while (rs.next())
              {
                ...
                procOggetto.setDataUltimoAggiornamento(NemboUtils.DATE
      ...
      throws InternalUnexpectedException
  {
    ...
    mapParameterSource.addValue("DESCRIZIONE_COMUNE",
        "%" + NemboUtils.STRING.nvl(descrComune).trim().toUpperCase() + "%",
        Types.VARCHAR);
    mapParameterSource.addValue("PROV_COMUNE",
        "%" + NemboUtils.STRING.nvl(prov).trim().toUpperCase() + "%",
        Types.VARCHAR);
  ...
  public List<GruppoOggettoDTO> getElencoOggetti(long idProcedimento,
      List<MacroCU> lMacroCdu, int idProcedimentoAgricolo) throws InternalUnexpectedException
  {
	  String THIS_METHOD = "[" + THIS_CLASS + "::getElencoOggetti]";
	    ...
	    final StringBuffer QUERY 
	    			= new StringBuffer( " SELECT                                                         \n"
						    		  ...
						    		  + "   PO.DATA_INIZIO,                                              \n"
						    		  + "   PO.DATA_FINE,                                                \n"
						    		  + "(SELECT TR.DATA_INIZIO FROM NEMBO_T_ITER_PROCEDIMENTO_OGGE TR    	\n"
						    		  ...
						    		  + "		FROM"
						    		  + "			NEMBO_R_BANDO_OGGETTO_QUADRO SBOQ,"
						    		  + "			NEMBO_R_QUADRO_OGGETTO_AZIONE SQOA"
						    		  + "		WHERE"
						    		  ...
						    		  + " )\n"
						    		  + " ORDER BY PO.CODICE_RAGGRUPPAMENTO, PO.DATA_INIZIO              \n");
	    	...
	    	return namedParameterJdbcTemplate.query(QUERY.toString(), mapParameterSource, new ResultSetExtractor<List<GruppoOggettoDTO>>()
	    			{
	    			  ...
	    			  public List<GruppoOggettoDTO> extractData(ResultSet rs) throws SQLException, DataAccessException
	    			  {
	    				  ...
	    				  while (rs.next())
	    		          {
	    					  ...
	    					  if((idGruppoOggetto != lastIdGruppoOggetto) || (codRaggruppamento != lastCodRaggruppamento))
	    					  {
	    						  lastIdGruppoOggetto = idGruppoOggetto;
	    						  lastCodRaggruppamento = codRaggruppamento;
	    						  gruppoOggettoDTO = new GruppoOggettoDTO();
	    						  gruppoOggettoDTO.setCodice(rs.getString("COD_GRUPPO_OGGETTO"));
	    						  gruppoOggettoDTO.setDescrizione(rs.getString("DESCR_GRUPPO_OGGETTO"));
	    						  gruppoOggettoDTO.setCodRaggruppamento(rs.getString("CODICE_RAGGRUPPAMENTO")); 
	    					  ...
	    					  oggettoDTO.setDataTrasmissione(rs.getTimestamp("DATA_TRASMISSIONE"));
	    					  ...
	    					  oggettoDTO.setIdProcedimentoOggetto(rs.getLong("ID_PROCEDIMENTO_OGGETTO"));
	    					  ...
	    					  //if ("S".equals(oggettoDTO.getFlagIstanza())) {
	  							DecodificaDTO<String> protocollo;
								try {
									protocollo = findProtocolloOggettoIstanza(oggettoDTO.getIdProcedimentoOggetto());
									oggettoDTO.setDataTrasmissioneStr(protocollo.getDescrizione());
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = "		SELECT 																				\n"
        ...
        + " 	FROM                                                                         		\n"
        + "   		NEMBO_T_PROCEDIM_OGGETTO_STAMP A,                                             	\n"
        + "   		NEMBO_T_PROCEDIMENTO_OGGETTO PO,													\n"
        + "   		NEMBO_R_OGGETTO_ICONA B,                                                     		\n"
    ...
    try
    {
      ...
      SELECT.append(
          "( 	SELECT   																											\n"
              + "					I4.DESCRIZIONE   																								\n"
              + "			   	FROM 																												\n"
              + "					NEMBO_T_PROCEDIMENTO_OGGETTO I1, NEMBO_T_ITER_PROCEDIMENTO_OGGE I2 , NEMBO_R_LEGAME_gRUPPO_OGGETTO I3,  			\n"
              + "						    	        NEMBO_D_OGGETTO I4																			\n"
              ...
              + "						    	                            		MAX(II2.DATA_INIZIO)   											\n"
              + "						    	                          		FROM 																\n"
              + "																	NEMBO_T_PROCEDIMENTO_OGGETTO II1, 								\n"
              + "																	NEMBO_T_ITER_PROCEDIMENTO_OGGE II2   							\n"
              + "						    	                          		WHERE 																\n"
              ...
              + "																FROM 																\n"
              + "																	NEMBO_T_PROCEDIMENTO_OGGETTO X1, 									\n"
              + "																	NEMBO_T_ITER_PROCEDIMENTO_OGGE X2 								\n"
              + "																WHERE 																\n"
              ...
              + "   NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ B                       								\n"
              + " WHERE                                                  								\n"
              ...
              + "    SMRCOMUNE_V_AMM_COMPETENZA VAM,                         							\n"
              + "    NEMBO_R_PROCEDIMENTO_LIVELLO PLIV,                        							\n"
              + "    NEMBO_D_LIVELLO DLIV,	                        		 							\n"
              + "    NEMBO_D_BANDO B,                                          							\n");
      ...
      {
        SELECT.append(
            " NEMBO_D_ESITO DE, NEMBO_R_LEGAME_GRUPPO_OGGETTO LGO,  									 								\n");
      }
      SELECT.append(
          " NEMBO_D_STATO_OGGETTO SO,                                 								\n"
              + "   SMRGAA_V_DATI_DELEGA VD                                  								\n"
      ...
      return namedParameterJdbcTemplate.query(SELECT.toString(),
          parameterSource, new ResultSetExtractor<List<ProcedimentoOggettoVO>>()
          {
                ...
                throws SQLException, DataAccessException
            {
              ...
              while (rs.next())
              {
                // Devo controllare idProcedimento perch� la query mi
                // restituisce pi� record se l'azienda ha pi�
                // procediemnto_oggetti
                // Sono sicuro che prendo l'ultimo id_procedimento_oggetto
                // perch� � una condizione di orderBY
      ...
      throws InternalUnexpectedException
  {
    ...
    QUERY
        .append("        (SELECT MIN(LGOMIN.ORDINE)                          \n"
            + "           FROM NEMBO_R_LEGAME_GRUPPO_OGGETTO LGOMIN                     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final StringBuffer QUERY = new StringBuffer(
        " SELECT                                                                                                                                          \n"
            ...
            + "     QB.ID_ELENCO_QUERY                                                                                                                                   	\n"
            + "    FROM                                                                                                                                                  	\n"
            + "     NEMBO_R_ELENCO_QUERY_BANDO QB,                                                                                                                         	\n"
            + "     NEMBO_D_ELENCO_QUERY EQ,                                                                                                                               	\n"
            + "     NEMBO_D_TIPO_VISUALIZZAZIONE TV                                                                                                                        	\n"
            + "    WHERE                                                                                                                                                 	\n"
            ...
            + "	AND  																																					\n"
            + "		 EXISTS (SELECT B.ID_BANDO FROM NEMBO_R_BANDO_OGGETTO B WHERE B.ID_BANDO = A.ID_BANDO AND B.FLAG_ATTIVO = 'S') 										\n"
            + "		)                                                  																								    \n"
            + "       OR 																																					\n"
            + "		(																																					\n"
            + "			A.DATA_FINE < SYSDATE 																															\n"
            + "				AND																																			\n"
            + "		 	EXISTS (SELECT A.ID_BANDO FROM NEMBO_T_PROCEDIMENTO C WHERE A.ID_BANDO = C.ID_BANDO) 																\n"
            + "  		 ) 																																					\n"
            + "   )                                                                                                                                                      	\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      SELECT = " SELECT 														\n"
          ...
          + " FROM														\n"
          + "	 NEMBO_T_NOTIFICA N,											\n"
          + "	 NEMBO_R_VISIBILITA_ATTORE VA,								\n"
          + "	 NEMBO_D_GRAVITA_NOTIFICA G,									\n"
          + "  NEMBO_D_VISIBILITA V											\n"
          + " WHERE														\n"
  ...
  public void deleteNotifica(long idNotifica) throws InternalUnexpectedException
  {
    ...
    final String DELETE = " DELETE FROM NEMBO_T_NOTIFICA	                                        \n"
      ...
      boolean isNewinsert) throws InternalUnexpectedException
  {
    ...
    String INSERT = "INSERT INTO NEMBO_T_NOTIFICA \n"
    ...
    try
    {
      if (!isNewinsert)
        ...
        mapParameterSource.addValue("ID_NOTIFICA",
            getNextSequenceValue("SEQ_NEMBO_T_NOTIFICA"), Types.NUMERIC);
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      if (idsPEOxP != null || idsPExP != null)
        SELECT.append("    pestrexp.flag_estratta	     				        \n");

      if (idsPO != null || idsPEOxP != null)
        SELECT.append(", po.IDENTIFICATIVO as IDENTIFICATIVO_OGGETTO,	 \n"
            ...
            + "		so.descrizione as STATO_OGGETTO				 	 \n");
      ...
      if (idsP != null || idsPO != null)
        SELECT.append(
            ",   NEMBO_T_PROCEDIMENTO_ESTRATTO pestr                \n");

      if (idsPExP != null || idsPEOxP != null)
        SELECT.append(", 				 \n"
            + "		NEMBO_T_PROCEDIMENTO_ESTR_EXPO 		pestrexp	 \n");
      ...
      if (idsPEOxP != null)
      {
        SELECT.append(getInCondition("po.id_procedimento_oggetto", idsPExP));
        SELECT.append("    and 														\n"
            + " pestrexp.id_procedimento_oggetto = po.id_procedimento_oggetto   		\n"
    ...
    try
    {
      ...
      SELECT.append(
          "  SELECT  DISTINCT                                          			\n"
              ...
              + "  FROM                                                      			\n"
              + "    NEMBO_T_PROCEDIMENTO_ESTRATTO PE,                         			\n"
              + "    NEMBO_T_PROCEDIMENTO_OGGETTO P	                      	 			\n"
              + "  where PE.ID_ESTRAZIONE_CAMPIONE =:ID_ESTRAZIONE           			\n"
      ...
      long idIntermediario) throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT DISTINCT                                     \n"
        ...
        + " FROM                                                \n"
        + "   NEMBO_T_PROCEDIMENTO A,                             \n"
        + "   NEMBO_T_PROCEDIMENTO_AZIENDA B,                     \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      SELECT = " SELECT DISTINCT  											\n"
          ...
          + " FROM  							 							\n"
          + "		NEMBO_R_LIVELLO_PADRE A, 									\n"
          + "		NEMBO_R_LIVELLO_PADRE B, 									\n"
          + "		NEMBO_D_LIVELLO C, 			 							\n"
          + "		NEMBO_R_LIVELLO_BANDO D, 									\n"
          + "		NEMBO_D_BANDO E, 											\n"
          + "		NEMBO_D_TIPO_LIVELLO F			 						\n"
          + " WHERE  						 								\n"
          ...
          new ResultSetExtractor<DecodificaDTO<String>>()
          {
                ...
                throws SQLException, DataAccessException
            {
              if (rs.next())
              {
                ...
                d.setDescrizione(NemboUtils.DATE
      ...
      Date dataDa, Date dataA) throws InternalUnexpectedException
  {
    ...
    String QUERY = "  SELECT  		                                                   								  \n"
        ...
        + "   NEMBO_T_PROCEDIMENTO_OGGETTO PO,							                            		  \n"
        + "   SMRGAA_V_DATI_DELEGA VD,                                 									  \n"
        + "   NEMBO_T_DETTAGLIO_INTERVENTO DETTINT,                         								  \n"
        + "   NEMBO_R_PROCEDIMENTO_LIVELLO PLIV	                        		                              \n"
        + " WHERE	                                       					   	                              \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      SELECT = " SELECT                                                                                                                        \n"
          ...
          + " FROM                                                                                                                          \n"
          + "   NEMBO_T_ITER_PROCEDIMENTO_GRUP A,                                                                                           \n"
          + "   NEMBO_D_STATO_OGGETTO B,                                                                                                      \n"
      ...
      long idProcedimentoOggetto) throws InternalUnexpectedException
  {
    ...
    final String QUERY =     " WITH PROTO_PO AS                                                                       \n"
    		  ...
    		  + "             PO.ID_PROCEDIMENTO_OGGETTO                                                 \n"
    		  + "           FROM                                                                         \n"
    		  + "               NEMBO_T_PROCEDIM_OGGETTO_STAMP A,NEMBO_T_PROCEDIMENTO_OGGETTO PO         \n"
    		  + "           WHERE PO.ID_PROCEDIMENTO_OGGETTO = :ID_PROCEDIMENTO_OGGETTO                  \n"
    		  + "               AND A.ID_PROCEDIMENTO_OGGETTO  = PO.ID_PROCEDIMENTO_OGGETTO              \n"
    		  + "               AND A.DATA_FINE IS NULL                                                  \n"
    		  + "               AND NVL(A.NUMERO_PROTOCOLLO_EMERGENZA, A.NUMERO_PROTOCOLLO) IS NOT NULL  \n"
    		  + "             ORDER BY NUM_PROTOCOLLO),                                                  \n"
    		  + "        PROTO_ITER AS                                                                   \n"
    		  + "         (SELECT                                                                        \n"
    		  ...
    		  + "             FROM                                                                       \n"
    		  + "               NEMBO_T_PROCEDIMENTO_OGGETTO A,                                          \n"
    		  + "               NEMBO_T_ITER_PROCEDIMENTO_OGGE B                                         \n"
    		  + "             WHERE                                                                      \n"
    		  + "               A.ID_PROCEDIMENTO_OGGETTO     = :ID_PROCEDIMENTO_OGGETTO                 \n"
    		  + "               AND A.ID_PROCEDIMENTO_OGGETTO = B.ID_PROCEDIMENTO_OGGETTO                \n"
    		  + "               AND ID_STATO_OGGETTO          in (10,30)                                 \n"
    		  + "               AND B.DATA_FINE               IS NULL)                                   \n"
    		  + "         SELECT                                                                         \n"
...
;
      ...
      throws InternalUnexpectedException
  {
    ...
    final String UPDATE = " INSERT                                      \n"
        ...
        + "   VALUES                                    \n"
        + "   (                                         \n"
        + "     SEQ_NEMBO_T_PROCEDIMENTO_GRUPP.NEXTVAL,            \n"
        + "     :ID_PROCEDIMENTO,                        \n"
        + "     :CODICE_RAGGRUPPAMENTO,                  \n"
        + "     :EXT_ID_UTENTE_AGGIORNAMENTO,                            \n"
        + "     SYSDATE,             \n"
        ...
        public DecodificaDTO<String> extractData(ResultSet rs) throws SQLException, DataAccessException
        {
          if (rs.next())
          {
            ...
            if(rs.getString("NUM_PROTOCOLLO")!=null &&rs.getString("DATA_PROTOCOLLO")!=null){
            	d.setCodice(rs.getString("NUM_PROTOCOLLO"));
	            d.setDescrizione(NemboUtils.DATE.formatDate(rs.getDate("DATA_PROTOCOLLO")));
	            return d;
            }	            
          }
          return new DecodificaDTO<String>();
