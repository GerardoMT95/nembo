...
public class ListeLiquidazioneDAO extends BaseDAO
{
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " WITH                                                                                                                          \n"
        ...
        + "     FROM                                                                                                                      \n"
        + "       NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LLIL,                                                                                      \n"
        ...
        + "   NEMBO_D_BANDO B,                                                                                                              \n"
        + "   IMPORTI IMP,                                                                                                                \n"
        + "   NEMBO_D_TIPO_IMPORTO TI,                                                                                                      \n"
        + "   SMRCOMUNE_V_AMM_COMPETENZA AC,                                                                                              \n"
        + "   NEMBO_T_FILE_LISTA_LIQUIDAZIONE FLL                                                                                           \n"
        + " WHERE                                                                                                                         \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    mapParameterSource.addValue("ID_TIPO_RUOLO",
        NemboConstants.GENERIC.ID_TIPO_RUOLO_TECNICO_LIQUIDATORE,
        Types.NUMERIC);
    try
    {
      return queryForDecodificaLong(QUERY, mapParameterSource);
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " SELECT                                                         \n"
        ...
        + "       NEMBO_T_IMPORTI_LIQUIDATI IL,                                      \n"
        + "       NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LLIL,                               \n"
        + "       NEMBO_R_RISOR_LIV_BAND_IMP_LIQ RLBIL                             \n"
        + "     WHERE                                                              \n"
    ...
    QUERY += "       AND PO.ID_PROCEDIMENTO = P.ID_PROCEDIMENTO                 \n"
        ...
        + "         *                                                              \n"
        + "       FROM                                                             \n"
        + "         NEMBO_R_RISOR_LIV_BANDO_AMM_CO RLBAC                           \n"
        + "       WHERE                                                            \n"
    ...
    mapParameterSource.addValue("ESITO_PRATICHE_LIQUIDABILI",
        NemboConstants.ESITO.LISTE_LIQUIDAZIONE.LIKE_ESITO_PRATICHE_LIQUIDABILI,
        Types.VARCHAR);
    try
    {
      return namedParameterJdbcTemplate.query(QUERY, mapParameterSource,
      ...
      throws InternalUnexpectedException
  {
    ...
    long idListaLiquidazione = getNextSequenceValue(
        "SEQ_NEMBO_T_LISTA_LIQUIDAZIONE");
    mapParameterSource.addValue("ID_LISTA_LIQUIDAZIONE", idListaLiquidazione,
        Types.NUMERIC);
    mapParameterSource.addValue("ID_BANDO", idBando, Types.NUMERIC);
    ...
    mapParameterSource.addValue("FLAG_STATO_LISTA",
        NemboConstants.STATO.LISTE_LIQUIDAZIONE.FLAG.BOZZA,
        Types.VARCHAR);
    mapParameterSource.addValue("ID_TIPO_IMPORTO", idTipoImporto,
        Types.NUMERIC);
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " INSERT                                                                 \n"
        + " INTO                                                                   \n"
        + "   NEMBO_R_RISOR_LIV_BAND_IMP_LIQ                                       \n"
        + "   (                                                                    \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " INSERT                                                                 \n"
        + " INTO                                                                   \n"
        + "   NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ                                         \n"
        + "   (                                                                    \n"
        ...
        + "   )                                                                    \n"
        + " SELECT                                                                 \n"
        + "   SEQ_NEMBO_R_LIST_LIQUI_IMP_LIQ.NEXTVAL,                               \n"
        + "   :ID_LISTA_LIQUIDAZIONE,                                              \n"
        + "   IL.ID_IMPORTI_LIQUIDATI,                                             \n"
        + "   'N',                                                                 \n"
        + "   SYSDATE                                                              \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " INSERT                                                           \n"
        ...
        + "   )                                                              \n"
        + " SELECT                                                           \n"
        + "   SEQ_NEMBO_R_IMPORTI_RIPARTITI.NEXTVAL,                           \n"
        ...
        + "   NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LLIL,                             \n"
        + "   NEMBO_T_IMPORTI_LIQUIDATI IL,                                    \n"
        + "   NEMBO_R_RIPARTIZIONE_CONTRIBUT RC                               \n"
        + " WHERE                                                            \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " INSERT                                              \n"
        + " INTO                                                \n"
        + "   NEMBO_T_FILE_LISTA_LIQUIDAZIONE                     \n"
        + "   (                                                 \n"
        ...
        + "   )                                                 \n"
        + " SELECT                                              \n"
        + "   SEQ_NEMBO_T_FILE_LISTA_LIQUIDAZI.NEXTVAL,           \n"
        + "   LL.ID_LISTA_LIQUIDAZIONE,                         \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String DELETE = "DELETE FROM NEMBO_R_RISOR_LIV_BAND_IMP_LIQ   		\n"
        + " WHERE ID_IMPORTI_LIQUIDATI IN (										\n"
        + " SELECT IL.ID_IMPORTI_LIQUIDATI FROM NEMBO_T_IMPORTI_LIQUIDATI IL,		\n"
        + "  NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LIL 									\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String DELETE = "DELETE FROM NEMBO_R_IMPORTI_RIPARTITI   						\n"
        + " WHERE ID_LISTA_LIQUIDAZ_IMP_LIQ IN (										\n"
        + " SELECT ID_LISTA_LIQUIDAZ_IMP_LIQ FROM NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ			\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT *                                                  \n"
        + " FROM NEMBO_T_FILE_LISTA_LIQUIDAZIONE 						\n"
        + " WHERE ID_LISTA_LIQUIDAZIONE=:idListaLiquidazione		  	\n";
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
    try
    {
  ...
  {
    final String QUERY = " SELECT 1 FROM NEMBO_D_BANDO WHERE ID_BANDO = (SELECT ID_BANDO FROM NEMBO_T_LISTA_LIQUIDAZIONE WHERE ID_LISTA_LIQUIDAZIONE=:ID_LISTA_LIQUIDAZIONE) FOR UPDATE ";
    MapSqlParameterSource mapParameterSource = new MapSqlParameterSource();
    mapParameterSource.addValue("ID_LISTA_LIQUIDAZIONE", idListaLiquidazione,
        Types.NUMERIC);
              ...
              if (rs.next())
              {
                ...
                if (extIdDocumentoIndex != null)
                {
                  ...
                  final Integer esito = esitoVO == null ? null
                      : esitoVO.getEsito();
                  if (esito != null
                      && esito == NemboConstants.SERVICE.AGRIWELL.RETURN_CODE.SUCCESS)
                  {
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " WITH                                                                       \n"
        ...
        + "         FROM                                                               \n"
        + "           NEMBO_T_IMPORTI_LIQUIDATI ILL,                                     \n"
        + "           NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LL3,                                \n"
        ...
        + "     FROM                                                                   \n"
        + "       NEMBO_r_importi_ripartiti irip2                                        \n"
        + "     WHERE                                                                  \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    mapParameterSource.addValue("ID_LISTA_LIQUIDAZIONE", idListaLiquidazione,
        Types.NUMERIC);
    mapParameterSource.addValue("FLAG_STATO_LISTA",
        NemboConstants.STATO.LISTE_LIQUIDAZIONE.FLAG.APPROVATA,
        Types.VARCHAR);
    mapParameterSource.addValue("EXT_ID_UTENTE_AGGIORNAMENTO",
        idUtenteAggiornamento, Types.NUMERIC);
    try
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      mapParameterSource.addValue("NOME_FILE",
          NemboUtils.FILE.getSafeSubmittedFileName(originalFilename),
          Types.VARCHAR);
      mapParameterSource.addValue("ID_STATO_STAMPA",
          NemboConstants.STATO.STAMPA.ID.FIRMATO_DIGITALMENTE,
          Types.NUMERIC);
      mapParameterSource.addValue("ID_LISTA_LIQUIDAZIONE", idListaLiquidazione,
          Types.NUMERIC);
      ...
      mapParameterSource.addValue("DATA_PROTOCOLLO_DOCUMENTO",
          NemboUtils.DATE.fromXMLGregorianCalendar(
      ...
      throws InternalUnexpectedException
  {
    ...
    String QUERY = " SELECT                                                             \n"
        ...
        + "      	NEMBO_R_LEGAME_GRUPPO_OGGETTO LGO2,                               	\n"
        + "     	NEMBO_D_OGGETTO O2                           				        	\n"
        + "			,NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LLIL2,                                \n"
        + "			NEMBO_T_IMPORTI_LIQUIDATI ILL2                                        \n"
        + "     WHERE                       	                      					\n"
         ...
         * "     FROM                                                       				\n"
         * +
         * "     NEMBO_T_IMPORTI_LIQUIDATI ILL, NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LL3    		\n"
         * +
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT 								\n"
        ...
        + "   FROM 												\n"
        + "		NEMBO_D_BANDO BB, 								\n"
        + "		NEMBO_R_LIVELLO_BANDO LIVB, 						\n"
        + "		NEMBO_D_LIVELLO W1, 								\n"
        + "		NEMBO_R_LIVELLO_PADRE W2, 						\n"
        + "		NEMBO_R_LIVELLO_PADRE W3,							\n"
        + "		NEMBO_D_LIVELLO LIV 								\n"
      ...
      throws InternalUnexpectedException
  {
    ...
    QUERY += "       AND                                                                \n"
        ...
        + "     FROM                                                                   \n"
        + "       PROC_OGG PROC,                                                       \n"
        + "       NEMBO_T_ESITO_FINALE EF,                                               \n"
        + "       SMRCOMUNE_V_TECNICO T,                                               \n"
        + "       SMRCOMUNE_V_TECNICO T2,                                              \n"
        + "       TECNICO_LIQUIDATORE TL,                                              \n"
        + "       NEMBO_T_ESITO_OPERAZIONE EO                                            \n"
        + "     WHERE                                                                  \n"
        ...
        + "     FROM                                                                   		\n"
        + "       PROC_OGG PROC,                                                       		\n"
        + "       NEMBO_T_CONTROLLO_IN_LOCO CL,                                              	\n"
        + "       SMRCOMUNE_V_TECNICO T,                                               		\n"
        + "       TECNICO_LIQUIDATORE TL                                               		\n"
        + "     WHERE                                                                  		\n"
        + "       CL.ID_PROCEDIMENTO_OGGETTO IN (                                    	  		\n"
        ...
        + "     FROM                                                                   		\n"
        + "       PROC_OGG PROC,                                                       		\n"
        + "       NEMBO_T_VISITA_LUOGO  VL,                                              		\n"
        + "       SMRCOMUNE_V_TECNICO T,                                               		\n"
        + "       TECNICO_LIQUIDATORE TL                                               		\n"
        + "     WHERE                                                                  		\n"
        + "       VL.ID_PROCEDIMENTO_OGGETTO IN (                                    			\n"
        + "			SELECT ID_PROCEDIMENTO_OGGETTO                                  		\n"
        + "			FROM NEMBO_T_PROCEDIMENTO_OGGETTO PO                                    	\n"
        + "			WHERE PO.ID_PROCEDIMENTO = (                                   			\n"
        + "				SELECT ID_PROCEDIMENTO                                    			\n"
    ...
    try
    {
      if (exception instanceof ApplicationException)
      {
        mapParameterSource.addValue("DESCRIZIONE_ERRORE",
            NemboUtils.STRING.substr(exception.getMessage(), 0, 4000));
      }
      else
      {
        mapParameterSource.addValue("DESCRIZIONE_ERRORE",
      ...
      throws InternalUnexpectedException
  {
    ...
    QUERY += " FROM                                                                  \n"
        ...
        + "   NEMBO_D_LIVELLO L,                                                     		\n"
        + "   SMRGAA_V_DATI_ANAGRAFICI DA,												\n"
        + "	  NEMBO_T_LISTA_LIQUIDAZIONE LIQ,                                        		\n"
        + "   NEMBO_T_PROCEDIMENTO_AZIENDA PAZ,                                     		\n"
        + "	  NEMBO_R_LISTA_LIQUIDAZ_IMP_LIQ LLIQ                                        	\n"
        + " WHERE                                                                  		\n"
