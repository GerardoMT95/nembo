...
public class EstrazioniDAO extends BaseDAO
{
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                                                                                              \n"
        ...
        + " FROM                                                                                                                                                \n"
        + "   NEMBO_D_NUMERO_LOTTO A,                                                                                                                             \n"
        + "   NEMBO_T_IMPORTI_ESTRAZ_DP B,                                                                                                                        \n"
        + "   NEMBO_D_LIVELLO C                                                                                                                                   \n"
        + " WHERE                                                                                                                                               \n"
      ...
      long idNumeroLotto) throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                     \n"
        ...
        + "   NEMBO_D_NUMERO_LOTTO A,                    \n"
        + "   NEMBO_T_IMPORTI_ESTRAZ_DP B,               \n"
        + "   NEMBO_D_STATO_ESTRAZIONE DSE,              \n"
        + "   NEMBO_D_TIPO_ESTRAZIONE DTE,               \n"
        + "   NEMBO_D_LIVELLO C                          \n"
        + " WHERE                                      \n"
      ...
      long idNumeroLotto) throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                                                                                   \n"
        ...
        + "   (SELECT SUM(T.IMPORTO_RICHIESTO) FROM NEMBO_T_ANALISI_RISCHIO_IMP T WHERE T.ID_ANALISI_RISCHIO = A.ID_ANALISI_RISCHIO) AS IMP_RICHIESTO, \n"
        + "   A.PUNTEGGIO,                                                                                                                           \n"
        + "   A.CLASSE,                                                                                                                              \n"
        + "   A.FLAG_ESTRATTA,                                                                                                                       \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    StringBuffer CALL = new StringBuffer(
        "PCK_NEMBO_ESTRAZ_CAMPIONE_DP.RegistraDP");
    if (logger.isDebugEnabled())
    {
    ...
    try
    {
      ...
      SimpleJdbcCall call = new SimpleJdbcCall(
          (DataSource) appContext.getBean("dataSource"))
              .withCatalogName("PCK_NEMBO_ESTRAZ_CAMPIONE_DP")
      ...
      throws InternalUnexpectedException
  {
    ...
    final String INSERT = "INSERT INTO NEMBO_D_NUMERO_LOTTO 	\n"
        + " (ID_NUMERO_LOTTO, 				\n"
        + "	 DATA_ELABORAZIONE, 			\n"
        + "	 DESCRIZIONE, 					\n"
        + "	 ID_TIPO_ESTRAZIONE, 			\n"
    ...
    try
    {
      idNumeroLotto = getNextSequenceValue("SEQ_NEMBO_D_NUMERO_LOTTO");
      mapParameterSource.addValue("ID_NUMERO_LOTTO", idNumeroLotto,
          Types.NUMERIC);
      mapParameterSource.addValue("ID_TIPO_ESTRAZIONE", idTipoEstrazione,
          Types.NUMERIC);
      ...
      throws InternalUnexpectedException
  {
    ...
    StringBuffer CALL = new StringBuffer(
        "PCK_NEMBO_ESTRAZ_CAMPIONE_DP.CaricaDP");
    if (logger.isDebugEnabled())
    {
      logger.debug("[" + THIS_CLASS + ":: " + THIS_METHOD + "] BEGIN.");
    }
      ...
      throws InternalUnexpectedException
  {
    ...
    StringBuffer CALL = new StringBuffer(
        "PCK_NEMBO_ESTRAZ_CAMPIONE_DP.EstraiDP");
    if (logger.isDebugEnabled())
    {
      logger.debug("[" + THIS_CLASS + ":: " + THIS_METHOD + "] BEGIN.");
    }
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                           \n"
        ...
        + "   DSE.DESCRIZIONE AS DESCR_STATO_ESTRAZIONE, 	   \n"
        + "   A.DATA_CUTOFF,                           	   \n"
        + "   (SELECT E.MOTIVAZIONE_ANNULLAMENTO  FROM NEMBO_T_ESTRAZIONE_CAMPIONE E WHERE E.ID_NUMERO_LOTTO = A.ID_NUMERO_LOTTO)  AS MOTIVAZIONE                          	   \n"
        + " FROM                                             \n"
        + "   NEMBO_D_NUMERO_LOTTO A,                          \n"
        + "   NEMBO_D_STATO_ESTRAZIONE DSE,              	   \n"
        + "   NEMBO_D_TIPO_ESTRAZIONE DTE                       \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String DELETE = " DELETE FROM NEMBO_T_ANALISI_RISCHIO_IMP                                     \n"
      ...
      long idNumeroLotto) throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                                                                                              \n"
        ...
        + "   NEMBO_D_LIVELLO MISURA,                                                                                                                             \n"
        + "   NEMBO_D_LIVELLO AZIONE                                                                                                                              \n"
        + " WHERE                                                                                                                                               \n"
        + "   A.ID_NUMERO_LOTTO = :ID_NUMERO_LOTTO                                                                                                              \n"
        + "   AND B.ID_NUMERO_LOTTO = A.ID_NUMERO_LOTTO                                                                                                         \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                                         \n"
        ...
        + "   NEMBO_T_PROCEDIMENTO_ESTR_EXPO A1 where A1.FLAG_ESTRATTA = A.FLAG_ESTRATTA ) \n"
        + " ORDER BY                                                                       \n"
        + "  A.FLAG_CONTROLLO_IN_LOCO, A.DESCRIZIONE DESC                                  \n";
