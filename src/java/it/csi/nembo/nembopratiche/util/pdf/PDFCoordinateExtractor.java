...
import it.csi.nembo.nembopratiche.util.pdf.IValuableElement.ValuableElementType;
      ...
      if (element.getType() == ValuableElementType.TEXT)
      {
        ...
        if (testoProtocollo != null)
        {
          if (testoProtocollo.equals(text))
          {
             ...
             * il pdf � strutturato correttamente su Modol quello � il box della
             * firma
             */
            if (lastBox != null)
            {
            ...
            {
              /*
               * C'� qualcosa di fortemente sbagliato... la struttura del pdf �
