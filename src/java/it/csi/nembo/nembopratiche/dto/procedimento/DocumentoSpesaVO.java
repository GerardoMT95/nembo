package it.csi.nembo.nembopratiche.dto.procedimento;
...
public class DocumentoSpesaVO implements ILoggable
{
  ...
  public String getImportoAssociatoRicStr()
  {
    return (importoAssociatoRic != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(importoAssociatoRic)
        : "";
  }
  ...
  public String getImportoLordoPagamentoStr()
  {
    return (importoLordoPagamento != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(importoLordoPagamento)
        : "";
  }
  ...
  public String getImportoAncoraDaRendicontareStr()
  {
    ...
    return (impDaRend != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(impDaRend) : "";
  }
  ...
  public String getImportoLordoStr()
  {
    ...
    return (ret != null) ? "&euro; " + NemboUtils.FORMAT.formatCurrency(ret)
        : "";
  }
  ...
  public String getImportoIvaStr()
  {
    return (importoIva != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(importoIva) : "";
  }
  ...
  {
    return NemboUtils.DATE.formatDate(dataDocumentoSpesa);
  }
  ...
  {
    return NemboUtils.DATE.formatDate(dataPagamento);
  }
  ...
  public String getImportoSpesaStr()
  {
    return (importoSpesa != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(importoSpesa) : "";
  }
  ...
  public String getImportoRendicontatoStr()
  {
    ...
    return (importoRendicontato != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(importoRendicontato)
        : "";
  }
  ...
  public String getImportoRendicontatoStr2()
  {
    importoRendicontato = getImportoRendicontato();
    return (importoRendicontato != null)
        ? NemboUtils.FORMAT.formatCurrency(importoRendicontato) : "";
  }
  ...
  public String getNomeFileLogicoDocumentoSpeLink()
  {
    ...
    return nomeFileLogicoDocumentoSpe + " <a href=\"../cunembo263m/download_"
  ...
  public String getImportoDaRendicontareStr()
  {
    return (importoDaRendicontare != null)
        ? "&euro; " + NemboUtils.FORMAT.formatCurrency(importoDaRendicontare)
        : "";
  }
