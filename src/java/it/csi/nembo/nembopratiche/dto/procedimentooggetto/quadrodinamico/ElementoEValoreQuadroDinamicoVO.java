...
import it.csi.nembo.nembopratiche.dto.CheckBox;
...
public class ElementoEValoreQuadroDinamicoVO implements ILoggable
{
  ...
  public String getValoreCompleto()
  {
    if (valori != null)
    {
      ...
      for (DatoElementoQuadroDTO dato : valori)
      {
        ...
        sb.append(NemboUtils.QUADRODINAMICO.formatValoreElementoQuadro(dato,
            elemento));
      }
      return sb.toString();
    }
  ...
  {
    return valori == null || valori.isEmpty() ? null
        : NemboUtils.QUADRODINAMICO.formatValoreElementoQuadro(valori.get(0),
            elemento, true);
  }
    ...
    if (vociElemento != null && !vociElemento.isEmpty())
    {
      ...
      for (int i = 0; i < size; ++i)
      {
        ...
        CheckBox chk = new CheckBox(codiceVoce, voce.getValore(),
            NemboUtils.ARRAY.contains(valori, codiceVoce));
        list.add(chk);
      }
    }
    return list;
