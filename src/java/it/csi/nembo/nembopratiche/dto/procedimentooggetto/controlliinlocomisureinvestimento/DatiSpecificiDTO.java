package it.csi.nembo.nembopratiche.dto.procedimentooggetto.controlliinlocomisureinvestimento;
...
public class DatiSpecificiDTO extends ControlliInLocoInvestDTO
{
  ...
  {
    return !NemboConstants.FLAGS.ESTRAZIONE_CAMPIONE.MODALITA_SELEZIONE.NON_ESTRATTA
        .equals(flagEstratta)
        && !NemboConstants.FLAGS.ESTRAZIONE_CAMPIONE.MODALITA_SELEZIONE.DICHIARAZIONI_SOSTITUTIVE
            .equals(flagEstratta);
  }
}
