package it.csi.nembo.nembopratiche.dto.error;
...
public class Errors extends HashMap<String, String>
{
  ...
  {
    Date date = NemboUtils.DATE.parseDate(data);
    if (date != null)
    {
      ...
      boolean equalAccepted, String msgErrore)
  {
    ...
    if (date != null)
    {
      if (equalAccepted)
      {
        Date dataR = NemboUtils.DATE.parseDate(dataRif);
      ...
      {
        if (!date.after(NemboUtils.DATE.parseDate(dataRif)))
        {
          // Data minima non rispettata
          addError(filedName, msgErrore);
          return null;
      ...
      boolean equalAccepted, String msgErrore)
  {
    ...
    Date date = NemboUtils.DATE.parseDate(dataAl);
    if (date != null)
    {
      if (equalAccepted)
      {
        Date dataR = NemboUtils.DATE.parseDate(dataDal);
        if (date.before(dataR))
        {
          // Data minima non rispettata
          addError(filedName, msgErrore);
      ...
      {
        if (!date.after(NemboUtils.DATE.parseDate(dataDal)))
        {
          // Data minima non rispettata
          addError(filedName, msgErrore);
          return null;
      ...
      boolean equalAccepted)
  {
    ...
    if (date != null)
    {
      ...
      {
        if (!date.after(NemboUtils.DATE.getCurrentDateNoTime()))
        {
          // Data minima non rispettata
      ...
      boolean equalAccepted)
  {
    ...
    if (date != null)
    {
      ...
      {
        if (!date.before(NemboUtils.DATE.getCurrentDateNoTime()))
        {
          // Data minima non rispettata
      ...
      long min, long max)
  {
    try
    {
      ...
      {
        addError(fieldName,
            "Valore non permesso, il valore minimo ammesso � " + min);
        return null;
      }
      else
      {
        ...
        {
          addError(fieldName,
              "Valore non permesso, il valore massimo ammesso � " + max);
          return null;
        }
      }
      return value;
      ...
      String fieldName, int numDecimalDigit, BigDecimal min, BigDecimal max)
  {
    try
    {
      ...
      {
        addError(fieldName, "Valore non permesso, il valore minimo ammesso � "
      ...
      else
      {
        ...
        {
          addError(fieldName,
              "Valore non permesso, il valore massimo ammesso � "
