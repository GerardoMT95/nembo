...
public class RigaJSONElencoListaLiquidazioneDTO implements ILoggable
{
  ...
  {
    return NemboUtils.DATE.formatDateTime(dataCreazione);
  }
  ...
  {
    return NemboUtils.DATE.getYearFromDate(dataCreazione);
  }
  ...
  {
    return NemboUtils.DATE.formatDateTime(dataInvioSigop);
  }
