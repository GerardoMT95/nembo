...
public class ImportoLiquidatoDTO implements ILoggable
{
  ...
  {
    return NemboUtils.DATE.formatDateTime(dataCreazioneDecreto);
  }
  ...
  {
    return NemboUtils.DATE.formatDateTime(dataCreazioneMandato);
  }
  ...
  {
    return NemboUtils.DATE.formatDateTime(dataEffettuazionePagamento);
  }

  public String getDataCreazioneStr()
  {
    return NemboUtils.DATE.formatDate(dataCreazione);
  }
  ...
  {
    return NemboUtils.DATE.formatDate(dataApprovazione);
  }

  public String getDataEffettuazioneStr()
  {
    return NemboUtils.DATE.formatDateTime(dataEffettuazione);
  }

  public String getDataInvioSigopStr()
  {
    return NemboUtils.DATE.formatDate(dataInvioSigop);
  }
  ...
  {
    return NemboUtils.DATE.formatDate(dataProtocollo);
  }
}
