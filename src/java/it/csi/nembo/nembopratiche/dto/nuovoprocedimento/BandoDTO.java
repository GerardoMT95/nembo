package it.csi.nembo.nembopratiche.dto.nuovoprocedimento;
...
public class BandoDTO implements ILoggable
{
  ...
  private BigDecimal 					percContributoMaxConcessa;
	...
	public String getDescrizioneEvento()
	{
		if(dataEvento != null)
		{
			return NemboUtils.DATE.getYearFromDate(dataEvento) + " - " + getDescEventoCalamitoso();
		}
		else
		{
			return null;
	...
	public String getPercContributoErogabileFormatted()
	{
		...
		{
			return NemboUtils.FORMAT.formatDecimal2(percContributoErogabile) + "%";
		}
		else
		{
			return null;
	...
	public String getPercContributoMaxConcessaFormatted()
	{
		...
		{
			return NemboUtils.FORMAT.formatDecimal2(percContributoMaxConcessa) + "%";
		}
		else
		{
			return null;
