...
import it.csi.nembo.nembopratiche.dto.DocumentoDTO;
...
public class LivelloDTO implements ILoggable
{
  ...
  {
    return NemboUtils.DATE.formatDate(dataInizioControllo);
  }

  public String getDataSopralluogoStr()
  {
    return NemboUtils.DATE.formatDate(dataSopralluogo);
  }
