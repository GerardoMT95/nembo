...
@Controller
@NemboSecurity(value = "CU-NEMBO-212-V", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo212v")
public class CUNEMBO212VAccertamentoMedianteDocumentiSpesa
