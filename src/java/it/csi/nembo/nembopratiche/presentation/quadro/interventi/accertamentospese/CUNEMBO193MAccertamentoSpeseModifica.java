...
@Controller
@NemboSecurity(value = "CU-NEMBO-193-M", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo193m")
public class CUNEMBO193MAccertamentoSpeseModifica
    extends CUNEMBO193AccertamentoSpeseAbstract
{
      ...
      throws InternalUnexpectedException
  {
    ...
    for (RigaAccertamentoSpese riga : elenco)
    {
      ...
      if (isSpesaSostenutaAttuale)
      {
        ...
        if (!usaDocumentiSpesa)
        {
          ...
          importoNonRiconosciutoSanzionabile = errors
              .validateMandatoryBigDecimalInRange(
    ...
    {
      rendicontazioneEAccertamentoSpeseEJB.updateAccertamentoSpeseAcconto(list,
