...
@Controller
@NemboSecurity(value = "CU-NEMBO-213-M", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo213m")
public class CUNEMBO213MControlloInLocoMisureInvestimentoModifica
    extends BaseController
{
      ...
      DatiSpecificiDTO datiSpecifici) throws InternalUnexpectedException
  {
    ...
    model.addAttribute("modalitaSelezione",
        CUNEMBO213DControlloinlocoMisureInvestimentoDettaglio
            .getHtmlDecodificaModalitaSelezione(
      ...
      throws InternalUnexpectedException
  {
    DatiSpecificiDTO datiSpecifici = quadroEJB
        .getDatiSpecifici(idProcedimentoOggetto, idProcedimento);
      ...
      HttpServletRequest request) throws InternalUnexpectedException
  {
    ...
    else
    {
      ...
      quadroEJB.updateOrInsertControlliInLocoInvest(controlliInLocoInvestDTO,
      ...
      throws InternalUnexpectedException
  {
    ...
    {
      // Inserimento
      return "redirect:../cunembo213d/index.do";
    }
    else
    {
      model.addAttribute("preferRequest", Boolean.TRUE);
