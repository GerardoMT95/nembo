...
@Controller
@NemboSecurity(value = "CU-NEMBO-192-V", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo192v")
public class CUNEMBO192VVisualizzaDocumentiSpesaRendicontazione
    extends CUNEMBO192RendicontazioneSpeseAbstract
{
      ...
      throws InternalUnexpectedException
  {
    ...
    Map<String, Object> common = getCommonFromSession("CU-NEMBO-192", session,
        true);
