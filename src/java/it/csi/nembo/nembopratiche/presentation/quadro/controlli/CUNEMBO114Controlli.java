...
@Controller
@RequestMapping("/cunembo114")
@NemboSecurity(value = "CU-NEMBO-114", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUNEMBO114Controlli extends BaseController
{
  @Autowired
