...
public abstract class Localizza extends LocalizzazioneJSON
{
      ...
      throws InternalUnexpectedException
  {
    ...
    else
    {
      httpHeaders.add("Content-type",
          NemboUtils.FILE.getMimeType(file.getNomeFisico()));
      ...
      throws InternalUnexpectedException, IOException
  {
    ...
    if (errors.isEmpty())
    {
      ...
      file.setNomeFisico(NemboUtils.FILE
      ...
      throws InternalUnexpectedException
  {
    ...
    model.addAttribute("provincie",
        interventiEJB.getProvincieConTerreniInConduzione(
            ...
            NemboConstants.GENERIC.ID_REGIONE_BASILICATA,
      ...
      throws InternalUnexpectedException
  {
    model.addAttribute("provincie",
        interventiEJB
            .getProvincie(NemboConstants.GENERIC.ID_REGIONE_BASILICATA));
    model.addAttribute("comuneDisabled", Boolean.TRUE);
    model.addAttribute("sezioneDisabled", Boolean.TRUE);
      ...
      throws InternalUnexpectedException
  {
    ...
    if (errors.addToModelIfNotEmpty(model))
    {
      ...
      if (!GenericValidator.isBlankOrNull(istatProvincia))
      {
        List<DecodificaDTO<String>> comuni = interventiEJB.getDecodificheComuni(
            null, istatProvincia, NemboConstants.FLAGS.NO);
    ...
    else
    {
      interventiEJB.insertLocalizzazioneParticelle(idProcedimentoOggetto,
          idIntervento,
          NemboUtils.LIST.toListOfLong(idParticellaCertificata),
      ...
      throws InternalUnexpectedException
  {
    ...
    else
    {
      ...
      session.setAttribute(FiltroRicercaConduzioni.class.getName(),
          filtroRicercaConduzioni);
      return "interventi/popupRicercaConduzioni";
    }
  }
      ...
      throws InternalUnexpectedException
  {
    ...
    filtroRicercaParticelle.setIdParticellaCertificata(NemboUtils.LIST
      ...
      HttpServletRequest request) throws InternalUnexpectedException
  {
                                                  ...
                                                  // basta che esista
    {
      ...
      else
      {
        ...
        interventiEJB.insertLocalizzazioneComuni(
            ...
            idIntervento, ids, logOperationOggettoQuadroDTO, NemboConstants.FLAGS.NO, NemboConstants.FLAGS.NO, NemboConstants.FLAGS.NO);
        return "dialog/success";
      }
    }
    ...
    model.addAttribute("json_source",
        "../cunembo" + NemboUtils.APPLICATION.getCUNumber(request)
      ...
      throws InternalUnexpectedException
  {
                                                  ...
                                                  // basta che esista
    {
      ...
      else
      {
        ...
        LogOperationOggettoQuadroDTO logOperationOggettoQuadroDTO = getLogOperationOggettoQuadroDTO(
            session);
        String flagCanale = (request.getParameter("flagCanale"))!=null?NemboConstants.FLAGS.SI:NemboConstants.FLAGS.NO;
        String flagOpereDiPresa = (request.getParameter("flagOpereDiPresa"))!=null?NemboConstants.FLAGS.SI:NemboConstants.FLAGS.NO;
        String flagCondotta = (request.getParameter("flagCondotta"))!=null?NemboConstants.FLAGS.SI:NemboConstants.FLAGS.NO;
      ...
      for (RigaJSONConduzioneInteventoDTO conduzione : conduzioni)
      {
        ...
        BigDecimal superficieImpegnoBD = errors
            .validateMandatoryBigDecimalInRange(superficieImpegno, fieldName, 4,
                NemboConstants.MIN.SUPERFICIE_IMPEGNO_INTERVENTO,
                NemboConstants.MAX.SUPERFICIE_IMPEGNO_INTERVENTO);

        if (superficieImpegnoBD != null)
        {
          BigDecimal supUtilizzataBD = NemboUtils.NUMBERS
          ...
          if (superficieImpegnoBD.compareTo(supUtilizzataBD) > 0)
          {
            errors.addError(fieldName,
                "La superficie oggetto dell'intervento non pu� superare la \"superficie utilizzata\"");
