      ...
      throws ApplicationException, InternalUnexpectedException
  {
    ...
    if (istruzioneSqlControlli != null)
    {
      if (!errors.hasError(nomeParametro))
      {
         ...
         * validazione registrata su db. Richiamo solo se il campo � valorizzato
         * o se � null ma l'elemento non � obbligatorio
         */
  ...
  private static void addValidatorNU0()
  {
    addToValidatorMap(new SingleValueValidator()
    {
          ...
          String nomeParametro, Errors errors) throws ApplicationException
      {
        ...
        {
          // Non � un numero valido ==> quindi non serve tenerlo in memoria
          return null;
        }
      }
      ...
      throws ApplicationException
  {
    ...
    if (lunghezza == null)
    {
      throw new ApplicationException(
          "Si � verificato un errore grave nella configurazione del quadro dinamico. Contattare l'assistenza tecnica comunicando il seguente messaggio: Campo lunghezza dell'elemento #"
    ...
    if (lunghezza <= 0)
    {
      throw new ApplicationException(
          "Si � verificato un errore grave nella configurazione del quadro dinamico. Contattare l'assistenza tecnica comunicando il seguente messaggio: Campo lunghezza dell'elemento #"
              + elemento.getIdElementoQuadro() + " � zero o negativo!");
    }
    return lunghezza;
  }
}
