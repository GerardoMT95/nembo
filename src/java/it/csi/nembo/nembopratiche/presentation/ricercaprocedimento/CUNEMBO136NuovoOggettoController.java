...

  {
        ...
        || procedimento.getIdStatoOggetto() > 90)
    {
      ...
      model.addAttribute("msgErrore",
          "Il procedimento selezionato si trova in uno stato per cui non � possibile creare alcun Oggetto.");
      ...
      else
      {
        model.addAttribute("noConfirm", Boolean.TRUE);
        model.addAttribute("msgErrore",
            "Non � possibile creare alcun Oggetto sul procedimento selezionato.");
      }
