...
@Controller
@RequestMapping("/cunembo138")
@NemboSecurity(value = "CU-NEMBO-138", controllo = NemboSecurity.Controllo.PROCEDIMENTO)
public class CUNEMBO138EliminaOggettoController extends BaseController
{
      ...
      throws InternalUnexpectedException
  {
    setModelDialogWarning(model,
        ...
        "../cunembo138/popupindex_" + paginaPadre + "_" + idProcedimento + "_"
