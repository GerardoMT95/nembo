...
public class MyDropdown extends MyInputGroup
{
  ...
  {
    addJSFileToPage("/"+NemboConstants.NEMBOPRATICHE.WEB_CONTEXT+"/js/list.js");
  }
  ...
  {
    // Non deve fare nulla perch� l'id che viene passato NON deve finire sul
  ...
  {
    // Non deve fare nulla perch� ilname che viene passato NON deve finire sul
    // <div> della dropdown ma sull'input type="hidden" al suo interno, quindi
    // lo gestisco
    // a mano
  }
