...
public class BreadcrumbsTag extends BaseTag
{
  ...
  public int doEndTag() throws JspException
  {
    ...
    try
    {
      procedimentoOggetto = NemboFactory.getProcedimentoOggetto(
    ...
    try
    {
      buffer.append("<div class=\"container-fluid\">"
          + "    <div class=\"row NEMBO_breadcrumb\">"
          ...
          && "TRUE".equals(comeFromRicerca))
      {
        ...
        {
          buffer.append(" <li><a href=\"../cunembo129/index_"
        ...
        if (procedimentoOggetto != null)
        {
          ...
          Boolean noElenco = (Boolean) this.pageContext.getSession()
              .getAttribute(
                  NemboConstants.GENERIC.SESSION_NO_ELENCO_AZIENDA);
