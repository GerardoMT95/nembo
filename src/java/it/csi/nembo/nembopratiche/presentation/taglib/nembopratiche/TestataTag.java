...
public class TestataTag extends BaseTag
{
  ...
  public int doEndTag() throws JspException
  {
    ...
    try
    {
      procedimentoOggetto = NemboFactory.getProcedimentoOggetto(request);
    }
    catch (Exception e)
    {
    ...
    try
    {
      procedimento = NemboFactory.getProcedimento(request);
    }
    catch (Exception e)
    {
      throw new JspException(e);
      ...
      ProcedimentoOggetto procedimentoOggetto)
  {
    ...
    sb.append("<td>")
        .append(
            NemboUtils.STRING.nvl(procedimentoOggetto.getIdentificativo()))
        .append("</td>");
    sb.append("<td>")
        .append(NemboUtils.DATE
            .formatDateTime(procedimentoOggetto.getDataInizio()))
        .append("</td>");
    sb.append("<td>").append(
        NemboUtils.DATE.formatDateTime(procedimentoOggetto.getDataFine()))
        .append("</td>");
    sb.append("<td>")
        .append(escapeHtml(
            NemboUtils.STRING.nvl(procedimentoOggetto.getDescEsito())))
        .append("</td>");
    ...
    if (testataProcedimento != null)
    {
      ...
      if (dataCessazione != null)
      {
        sb.append(
            ...
            .append(NemboUtils.DATE.formatDate(dataCessazione));

        if (!GenericValidator
            .isBlankOrNull(testataProcedimento.getMotivoCessazione()))
        {
          sb.append("<br>Motivazione: " + NemboUtils.STRING
      ...
      sb.append(" dal ").append(NemboUtils.DATE
          .formatDateTime(procedimento.getDataUltimoAggiornamento()));

      if (NemboUtils.PAPUASERV.isMacroCUAbilitato(
          (UtenteAbilitazioni) pageContext.getSession()
              .getAttribute("utenteAbilitazioni"),
          NemboConstants.MACROCDU.ESTRAZIONE_CAMPIONE))
      {
        String estratta = NemboFactory
        ...
        {
          estratta = NemboFactory.getMotivoEsclusioneExPostProcedimento(
      ...
      Procedimento procedimento, ProcedimentoOggetto procedimentoOggetto)
  {
    ...
    {
      sb.append(
          "<li><a href=\"../cunembo263l/index.do\">Documenti Spesa</a></li>");
    }

    sb.append("<li><a href=\"../cunembo110/index_"
        + procedimento.getIdProcedimento() + ".do\">Notifiche</a></li>" +
        "<li><a onClick=\"openPageInPopup('../cunembo251/index.do','dlgModificaOD','Trasferimento pratica/ufficio di zona/funzionario istruttore', 'modal-large');return false;\" href=\"../cunembo251/.do\">Trasferimento Pratica/Assegnazione Istruttore  <span style=\"padding-left:4px\"></span></a></li>");
    sb.append(
        "<li><a href=\"../cunembo254l/index.do\">Prospetto economico</a></li>");
    sb.append("</ul> </div>");
  ...
  protected void appendIconCheckList(Procedimento procedimento,
      StringBuilder sb)
  {
    if (NemboConstants.TIPO_BANDO.INVESTIMENTO
    ...
    if (iconeTestata != null)
    {
      ...
      if (procedimentoOggetto.getDataFine() == null)
      {
        oggettoIconaDTO = iconeTestata
            .get(NemboConstants.USECASE.CHIUSURA_OGGETTO.ISTANZA);
        if (oggettoIconaDTO == null)
        {
          oggettoIconaDTO = iconeTestata
              .get(NemboConstants.USECASE.CHIUSURA_OGGETTO.ISTRUTTORIA);
        }
        if (oggettoIconaDTO != null)
        {
      ...
      {
        final boolean isEsitoOggettoNonRiapribile = NemboUtils.VALIDATION
        ...
        if (isEsitoOggettoNonRiapribile)
        {
          ...
          String errorMessage = "l'istanza non � pi� apribile perch� gi� trasmessa";
          if (oggettoIconaDTO == null)
          {
            errorMessage = "l'oggetto non � pi� apribile perch� gi� approvato ";
        ...
        {
          oggettoIconaDTO = iconeTestata
              .get(NemboConstants.USECASE.RIAPERTURA_OGGETTO.ISTANZA);
          if (oggettoIconaDTO == null)
          {
            oggettoIconaDTO = iconeTestata
                .get(NemboConstants.USECASE.RIAPERTURA_OGGETTO.ISTRUTTORIA);
          }
          if (oggettoIconaDTO != null)
          {
      ...
      oggettoIconaDTO = iconeTestata
          .get(NemboConstants.USECASE.TRASMISSIONE_ISTANZA);
      if (oggettoIconaDTO != null
      ...
      oggettoIconaDTO = iconeTestata
          .get(NemboConstants.USECASE.APPROVAZIONE_ISTRUTTORIA);
      if (oggettoIconaDTO != null
          && procedimentoOggetto.getDataFine() != null
      ...
      OggettoIconaDTO oggettoIconaDTO)
  {
    sb.append("\n<a class=\"pull-right ico_spaced ")
        .append(oggettoIconaDTO.getIcona().getNomeIcona())
        .append(
            "\" href=\"../cunembo140/index.do\" onclick=\"openPageInPopup('../cunembo140/popupindex.do', 'dlgTrasmetti', 'Trasmissione', 'modal-large', true);return false;\"");
    String tooltip = oggettoIconaDTO.getIcona().getTooltip();
    if (!GenericValidator.isBlankOrNull(tooltip))
    {
      sb.append(" title=\"").append(escapeHtml(tooltip)).append("\"");
      ...
      OggettoIconaDTO oggettoIconaDTO)
  {
    sb.append("\n<a class=\"pull-right ico_spaced ")
        .append(oggettoIconaDTO.getIcona().getNomeIcona())
        .append(
            "\" href=\"../cunembo140/index.do\" onclick=\"openPageInPopup('../cunembo232/popupindex.do', 'dlgApprova', 'Approvazione', 'modal-large', true);return false;\"");
    String tooltip = oggettoIconaDTO.getIcona().getTooltip();
    if (!GenericValidator.isBlankOrNull(tooltip))
    {
      sb.append(" title=\"").append(escapeHtml(tooltip)).append("\"");
      ...
      ProcedimentoOggetto procedimentoOggetto) throws JspException
  {
    ...
    if (procedimentoOggetto != null)
    {
      ...
      if (quadri != null)
      {
         ...
         * ElencoCduDTO dettagliCdu = NemboUtils.APPLICATION.getCdu(cu);
         * if(NemboConstants.FLAGS.SI.equals(dettagliCdu.getFlagHelp())) {
         * showHelp = true;
         * 
         * 
         * sb.append(
        ...
        for (QuadroOggettoDTO quadro : quadri)
        {
          ...
          sb.append("><a href=\"/")
              .append(NemboConstants.NEMBOPRATICHE.WEB_CONTEXT)
