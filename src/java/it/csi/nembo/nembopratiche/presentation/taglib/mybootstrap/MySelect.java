...
public class MySelect extends MyInputGroup
{
      ...
      InvocationTargetException
  {
    ...
    {
    	textMethod = "get" + Character.toUpperCase(codeProperty.charAt(0)) + codeProperty.substring(1);
    }
    if (header)
    {
  		...
  		IllegalAccessException, InvocationTargetException
  {
			...
			String finalChoiceValue)
	{
		...
		if (finalSelectedValue != null && NemboUtils.ARRAY.contains(finalSelectedValue, value))
		{
