...
public class MySelectChoice extends MySelect
{
	...
	protected void writeCustomTag(StringBuilder sb, String errorMessage) throws Exception {
		...
		String mySelectChoiceSelectedValue = NemboUtils.STRING.nvl(getTmpSelectedChoice(), DEFAULT_DATA_CHOICE);
...

	{
		...
		else if(defaultChoice == null && (currentValue == null || currentValue.equals(""))) //se non vi � nulla di default (null) oppure ho inserito una entry non esistente seleziona l'elemento che permette di visualizzare tutta la lista
		{
			selectedItem = true;
		}
