package it.csi.nembo.nembopratiche.presentation.taglib.nembopratiche.table;
...
import it.csi.nembo.nembopratiche.presentation.taglib.nembopratiche.table.dto.TableCellType;
import it.csi.nembo.nembopratiche.presentation.taglib.nembopratiche.table.dto.TableColumn;
import it.csi.nembo.nembopratiche.presentation.taglib.nembopratiche.table.dto.TableIcon;
...
public class TableTag extends BaseTag
{
      ...
      Map<String, Method> methods)
  {
    ...
    {
      sb.append(NemboUtils.STRING.nvl(value));
    }
    sb.append("</td>");
  }
      ...
      TableColumn colonna)
  {
    ...
    if (tipologia == null)
    {
      return escapeHtml(NemboUtils.STRING.nvl(valoreProprieta));
    }
    switch (tipologia)
    {
      case RADIO:
