  ...
  public int doEndTag() throws JspException
  {
    ...
    if (errors != null)
    {
      ...
      if (!done || force)
      {
        ...
        {
          bodyContent = "Sono stati rilevati degli errori nei dati inseriti. I campi errati sono stati contrassegnati in rosso, � necessario correggerli per proseguire";
        }
