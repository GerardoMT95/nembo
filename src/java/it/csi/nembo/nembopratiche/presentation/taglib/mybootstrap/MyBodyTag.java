...
import it.csi.nembo.nembopratiche.util.CustomTagUtils;
...
public abstract class MyBodyTag extends MyAbstractTag
{
  ...
  protected void includeRequiredJSFile()
  {
    ...
    // per settare in request (c'� il metodo di utilit� addJSFileToPage())
    // il/gli
  ...
  protected void addJSFileToPage(String jsFile)
  {
    ...
    else
    {
      ...
      {
        return; // Il file c'� gi�, inutile aggiungerlo di nuovo
      }
    }
    list.add(jsFile);
  }
