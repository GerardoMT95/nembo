...
import it.csi.nembo.nembopratiche.presentation.listeliquidazione.CUNEMBO226CreaNuovaListaLiquidazione.BandoOperazioneParametersVO;
...
@Controller
@RequestMapping("/cunembo227")
@NemboSecurity(value = "CU-NEMBO-227", controllo = NemboSecurity.Controllo.DEFAULT)
public class CUNEMBO227ElencoListeLiquidazione extends BaseController
{
