package it.csi.nembo.nembopratiche.presentation.testpdf;
...
public class TestPdfController
{
  ...
  public String generaTipo(@PathVariable("tipo") String tipo) throws Exception
  {
    ...
    final Stampa findStampaFinale = NemboUtils.STAMPA
  ...
  protected InfoStampa getInfoStampa(String tipo) throws ApplicationException
  {
    ...
    switch (tipo)
    {
      case TIPO_VERBALE:
        ...
        infoStampa.useCase = NemboConstants.USECASE.STAMPE_OGGETTO.GENERA_VERBALE_ISTRUTTORIA_DOMANDA_SOSTEGNO;
        break;
      case TIPO_LETTERA:
        infoStampa.idProcedimentoOggetto = ID_PROCEDIMENTO_ISTRUTTORIA[0];
        infoStampa.useCase = NemboConstants.USECASE.STAMPE_OGGETTO.GENERA_AMMISSIONE_FINANZIAMENTO;
        break;
      case TIPO_ISTANZA:
        infoStampa.idProcedimentoOggetto = ID_PROCEDIMENTO_ISTRUTTORIA[0];
        infoStampa.useCase = NemboConstants.USECASE.STAMPE_OGGETTO.GENERA_STAMPA_PRATICA;
        break;
      ...
      throws Exception
  {
    ...
    {
      // Sono differenti ==> questo � un caso da segnalare
      ...
      ApplicationException
  {
    ...
    AgriWellEsitoVO esito = NemboUtils.PORTADELEGATA
    ...
    // Se arrivo qua c'� stato un errore!
      ...
      throws IOException
  {
    final String fileName = BASE_PATH_ERRORS + tipo + "_" + getProgressivo()
        ...
        + NemboUtils.DATE.formatDateTime(dateBegin).replaceAll("[ /:]", "")
        + ".pdf";
