...
public abstract class DocumentiSpesaBaseController extends BaseController
{
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    if (tipoDocumentoSpesaVO != null)
    {
      ...
      if (idModalitaPagamento != null || NemboConstants.FLAGS.SI
          .equals(tipoDocumentoSpesaVO.getFlagIdModalitaPagamento())
          ...
          && documentoSpesaVOSession.getIdDocumentoSpesa() != 0)
      {
        ...
        if (ricevuteDoc != null && !ricevuteDoc.isEmpty())
        {
          ...
          if (documentoVO.getImportoSpesa() != null)
            ...
            {
              errors.addError("importoLordo",
                  "L'importo lordo deve essere superiore alla somma degli importi delle ricevute gi� inserite che �: "
                      + impRic);
            }
        }
      }

      if (!GenericValidator.isBlankOrNull(note) || NemboConstants.FLAGS.SI
      ...
      if (errors.isEmpty())
      {
        ...
        {
          // Se non � prevista la gestione fornitore salvo subito i
          // dati
      ...
      HttpServletRequest request) throws InternalUnexpectedException
  {
    ...
    return "redirect:../cunembo263l/elencoricevute.do";
  }
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      AnagraficaTributariaVO[] tributariaVOArray = NemboUtils.PORTADELEGATA
  ...
  {
    return NemboUtils.STRING.nvl(txt).replace(" ", "&");
  }
    ...
    else
    {
      ...
      if (quadroEJB.findFornitore(fornitoreDTO))
      {
        ...
        model.addAttribute("msgErrore",
            "Fornitore gi� esistente. Selezionarlo dal relativo elenco!");
        return "documentispesa/inseriscifornitore";
      }
      ...
      throws InternalUnexpectedException, ApplicationException
  {
        ...
        || !idProcedimentoList.contains(idProcedimento))
    {
      long idDocuemntoSpesaNew = quadroEJB.updateOrInsertDatiDocumentoSpesa(
          idProcedimento, NemboUtils.PAPUASERV.getFirstCodiceAttore(
              getUtenteAbilitazioni(session)),
          documentoSpesaVOSession);
      ...
      {
        model.addAttribute("msgErrore",
            "Non � possibile caricare il medesimo documento di spesa per lo stesso procedimento!");
        model.addAttribute("displayDatiFornitori", "none");
      ...
      {
        // Stiamo inserrendo lo stesso documento gi� presente su un
