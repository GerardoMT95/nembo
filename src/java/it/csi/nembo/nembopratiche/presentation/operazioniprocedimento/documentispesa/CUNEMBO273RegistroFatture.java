...
@Controller
@RequestMapping("/cunembo273")
@NemboSecurity(value = "CU-NEMBO-273", controllo = NemboSecurity.Controllo.DEFAULT)
public class CUNEMBO273RegistroFatture extends BaseController
{
  @Autowired
