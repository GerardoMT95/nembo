...
@Controller
@NemboSecurity(value = "CU-NEMBO-125", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping("/cunembo125")
public class CUNEMBO125ChiusuraOggetto extends BaseController
{
      ...
      throws InternalUnexpectedException
  {
    ...
    switch (result.getRisultato())
    {
      ...
      case NemboConstants.SQL.RESULT_CODE.ERRORE_GRAVE:
        ...
        {
          model.addAttribute("url", "../cunembo125/lista_errori.do");
    ...
    switch (result.getId())
    {
      case NemboConstants.SQL.RESULT_CODE.NESSUN_ERRORE:
        asyncEJB.generaStampePerProcedimento(idProcedimentoOggetto,
            procedimentoOggetto.getIdProcedimento());
        model.addAttribute("url", "../cunembo125/riepilogo.do");
  ...
  @NemboSecurity(value = "CU-NEMBO-125", controllo = NemboSecurity.Controllo.NESSUNO)
