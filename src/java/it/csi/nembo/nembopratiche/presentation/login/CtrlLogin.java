...
public class CtrlLogin
{
      ...
      HttpSession session) throws InternalException
  {
     ...
     * papua se questo bit � a 1 significa che l'utente ha fatto login tramite
     * SPID
     */
      ...
      throws InternalServiceException
  {
    ...
    catch (Exception e)
    {
      throw new InternalServiceException(
          "Si � verificato un errore interno durante l'accesso ai servizi di autenticazione di PAPUA",
