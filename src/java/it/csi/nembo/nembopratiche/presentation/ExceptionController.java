...
import it.csi.nembo.nembopratiche.dto.internal.MailAttachment;
...
public class ExceptionController extends BaseController
{
      ...
      HttpSession session) throws InternalServiceException
  {
    ...
    {
      logger.error(
          "[ExceptionController::internalError] Si � verificato un errore nell'accesso alla pagina "
              + request.getRequestURL(),
          exception);
    }
    ...
    else
    {
      ...
      {
        model.put("messaggio", "Si � verificato un errore interno del server");
      ...
      HttpSession session) throws InternalUnexpectedException
  {
    ...
    try
    {
      ...
      NemboUtils.MAIL.postMail("massimo.durando@consulenti.csi.it",
          new String[]
          { "massimo.durando@consulenti.csi.it" },
          null,
          "Invio segnalazione NEMBO - Pratiche",
