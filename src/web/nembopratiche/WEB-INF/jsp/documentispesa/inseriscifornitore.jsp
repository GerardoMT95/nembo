	...
	$( document ).ready(function() {
		...
		function avanti() {
			...
			if ($("input:radio:checked").length > 0)
				...
				showMessageBox("Attenzione", "Per proseguire � necessario selezionare un fornitore.", "modal-large");
		}
									...
									$('#firstRow')
											.before(
													"<div class=\"stdMessagePanel\">"
															...
															+ "  <p>Non � stato trovato nessun fornitore! Crea nuovo fornitore scegliendo \"inserisci\"</p>"
															+ " </div>" + " </div>");
