		...
		<c:if test="${updateSuccess != null}">
			...
			<m:panel id="flagRendicontazionePanel" title="tipo rendicontazione">
				...
				<table summary="Rendicontazione con IVA" class="table table-hover table-bordered table-condensed tableBlueTh" data-show-columns="true">
					<tbody>
						<tr >
						  <th class="col-sm-3 ">Il beneficiario, secondo quanto predisposto dal Bando, pu� richiedere l'IVA a sostegno?</th>
							<td>
			...
			<c:if test="${flagRendicontazioneConIva == 'X'}">
				<div class="stdMessagePanel">	
		            <div class="alert alert-warning">
		                <p>Per gestire i documenti spesa � necessario specificare se il beneficiario pu� o meno rendicontare l'IVA.</p>
		             </div>
		         </div>
			</c:if>
...
<script type="text/javascript">
	...
	function elimina(idDocumentoSpesa, flagEliminabile) {
		if (flagEliminabile == "N")
			showMessageBox("Attenzione!", "Il documento spesa non pu� essere eliminato.", 'modal-large');
		else{
