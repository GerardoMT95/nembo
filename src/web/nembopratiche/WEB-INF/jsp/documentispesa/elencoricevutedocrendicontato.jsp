			...
			<div class="col-sm-12">
				...
				<form name="elencoForm" id="elencoForm" method="post" action="../cunembo263m/confermaNewFile_${idDocSpesa}.do" enctype="multipart/form-data" style="padding-top: 2em;">
					...
					<c:if test="${tipoDocumentoSpesaVO.flagFileDocumentoSpesa != 'N'}">
                      ...
                      <div class="col-sm-9" >
                      <span class="text-danger">Allegare in un unico file il documento spesa e i documenti necessari per la tracciabilit� dei pagamenti, cos� come previsti dai bandi.</span>
                      </div>
                    </div>
		      ...
		      $.ajax(
		              {
		                ...
		                success : function(html)
		                {
		                  ...
		                  {
		                    doErrorTooltip();
		                    showMessageBox("Attenzione!", "Non � possibile eliminare il file perch� ad esso risultano associate nuove ricevute di pagamento. Per procedere con l'operazione occorre prima eliminare dall'elenco le nuove ricevute di pagamento inserite.", "modal-large");
							return false;
			                  }
		                },
		                error : function(jqXHR, html, errorThrown)
