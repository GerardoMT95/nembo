...
<p:utente/>
	...
	<p:messaggistica/><p:testata onlyCompanyData="true" showIter="true" cu="CU-NEMBO-111"/>

	<div class="container-fluid" id="content" style="margin-bottom:3em">
				<m:error />
		
		<h3>Modifica notifica</h3>

		<m:panel id="modificaNotifica">
		<form:form action="" modelAttribute="" method="post"
				...
				<m:textarea id="descrizione"
				 ...
				 <m:radio-list id="idGravita" name="gravita" list="${elencoGravita}" selectedValue="${idGravitaSelezionato}" 
					label="Gravit� *" inline="true"  labelSize="2" controlSize="10" valueProperty="id" textProperty="gravita" preferRequestValues="${prfvalues}"/>
				...
				<m:radio-list id="idStato" name="stato" list="${elencoStati}" selectedValue="${idStatoSelezionato}"
					label="Stato *" inline="true"  labelSize="2" controlSize="10" valueProperty="id" textProperty="descrizione" preferRequestValues="${prfvalues}"/>				
...
$( document ).ready(function() {
	...
	$("#idGravita_1").parent().after("&nbsp;<span style=\"padding-right:2em;\"><a style=\"vertical-align: middle;\" class=\"ico24 ico_warning \" rel=\"tooltip\" data-placement=\"right\"  title=\"Le notifiche warning non bloccano l'operativit� sugli oggetti del procedimento.\"></a></span>");
	$("#idGravita_3").parent().after("&nbsp;<span style=\"padding-right:2em;\"><a style=\"vertical-align: middle;\"  class=\"ico24 ico_errorB\" rel=\"tooltip\" data-placement=\"right\"  title=\"Le notifiche bloccanti bloccano l'operativit� su tutti gli oggetti di tipo istruttoria del procedimento.\"></a></span>");
	$("#idGravita_2").parent().after("&nbsp;<span style=\"padding-right:2em;\"><a style=\"vertical-align: middle;\"  class=\"ico24 ico_errorG\" rel=\"tooltip\" data-placement=\"right\"  title=\"Le notifiche gravi bloccano l'operativit� su tutti gli oggetti del procedimento.\"></a></span>");
