    ...
    function chiudiOggetto()
    {
      ...
      $.ajax(
      {
        ...
        error : function(xhr, status, text)
        {
          ...
          showMessageBox("Errore", "Si � verificato un problema grave nel richiamo dei controlli dell'oggetto, se il problema persistesse contattare l'assistenza tecnica e comunicare il seguente messaggio:<br /> errore nella chiamata ajax<br/>codice di errore = "+xhr.status+"<br />messaggio = "+text, 'modal-large');
          chiusuraInCorso=false;
        }
      });
    }
