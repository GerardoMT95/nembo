...
<body>
	...
	<div class="container-fluid" id="content">
		...
		<br/>
				...
				<table summary="tblDettaglioAllevamento" id="tblDettaglioAllevamento"
		...
		<table id="${tableName}" summary="tblDettaglioAllevamento"
		...
		>
			<thead>
				<tr>
					...
					<th data-field="quantitaProdottaFormatted" data-sortable="true" data-visible="${!colonneNascoste.visible(tableName,'quantitaProdottaFormatted')}" data-formatter="numberFormatter2" data-adder="importoAdder" data-totale="true">Quantita prodotta annua per unit�</th>
