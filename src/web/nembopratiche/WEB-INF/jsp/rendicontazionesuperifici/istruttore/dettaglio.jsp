						...
						<tbody>
							<c:forEach items="${elenco}" var="p">
								<tr>
									...
									<td class="numero">${p.superficieEffettiva}</td>
									<td class="numero"><fmt:formatNumber pattern="###,##0.0000" value="${p.superficieAccertataGis}" /></td>
									<td class="numero"><c:out value="${p.superficieIstruttoria}" /></td>
								</tr>
							</c:forEach>
						</tbody>
						<tfoot>
							<tr>
								...
								<th class="numero"><fmt:formatNumber pattern="###,##0.0000" value="${totaleSupIstruttoria}" /></th>
							</tr>
						</tfoot>
					</table>
				</m:panel>
