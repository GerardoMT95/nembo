				...
				<c:choose>
					<c:when test="${serviziOK}">
						<div class="alert alert-success">
							<img src="../img/success_big.png" style="width: 32px; height: 32px" alt="success"/> L'applicativo ${componentName} funziona normalmente, l'accesso al database �
							attivo. Non ci sono problemi nell'accesso ai servizi applicativi
						</div>
					</c:when>
					<c:otherwise>
						<div class="alert alert-warning">
							<img src="../img/warning_big.png" style="width: 32px; height: 32px" alt="attenzione"/> L'applicativo ${componentName} funziona normalmente, l'accesso al database �
