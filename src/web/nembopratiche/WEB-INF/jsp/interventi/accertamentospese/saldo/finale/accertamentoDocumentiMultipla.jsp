...
<body>
	...
	<form id="mainForm" name="mainForm" method="post" action="${action}">
      ...
      <m:error />
         ...
         <div style="margin-left:-1em" class="col-sm-12">
          ...
          <table summary="info Interventi" class="table table-hover table-bordered tableBlueTh " style="margin-top:1em">
			...
			<input type="hidden" name="confermaModificaRendicontazione" id="confermaModificaRendicontazione" role="s"
				...
				type="submit" name="confermaModificaRendicontazioneBtn" id="confermaModificaRendicontazioneBtn" role="s" class="btn btn-primary pull-right" value="conferma" /> <br style="clear: left" /> <br /> <br />
		</div>
	</form>
  ...
  function inputFormatterCalcoloContributo($value, row, index)
    ...
    $(document).ready(function()
    {
      ...
      {
        showConfirmMessageBox("Conferma modifica accertamento", 'Proseguendo con l\'operazione saranno reimpostate le sanzioni automatiche, anche quelle per cui � stato effettuato lo split. Per verificarle occorre consultare il quadro "Riduzioni sanzioni".', '', '#', 'acceptWarning()');
      }
      /*<c:forEach items="${interventi.values()}" var="intervento">*/
