	...
	<div id="filter-bar" style="float: left; position: relative; top: 10px"></div>
			...
			<thead>
				<tr>
					...
					<th  data-totale="true" data-adder="importoAdder" data-switchable="false" data-field="importoSpesa" data-formatter="numberFormatter2" data-adder="plainNumberAdder">Importo<br />documento
					</th>
					<th  data-totale="true" data-adder="importoAdder" data-switchable="false" data-field="importoRendicontato" data-formatter="numberFormatter2">Spesa<br />rendicontata attuale
					</th>
					<th  data-totale="true" data-adder="importoAdder" data-switchable="false" data-field="importoAccertatoBD" data-formatter="numberFormatter2">Spese<br />accertate attuali
					</th>
					<th  data-totale="true" data-adder="importoAdder" data-switchable="false" data-field="importoCalcoloContributoBD"  data-formatter="numberFormatter2">Spesa<br /> riconosciuta<br /> per il<br /> calcolo <br />del <br />contributo
					</th>
					<th   data-totale="true" data-adder="importoAdder" data-switchable="false" data-field="importoNonRiconosciutoBD"  data-formatter="numberFormatter2">Importo<br />non riconosciuto<br /> sanzionabile
					</th>
					<th   data-totale="true" data-adder="importoAdder" data-switchable="false" data-field="importoDisponibileBD"  data-formatter="numberFormatter2">Importo<br />non riconosciuto<br /> non sanzionabile
					</th>
