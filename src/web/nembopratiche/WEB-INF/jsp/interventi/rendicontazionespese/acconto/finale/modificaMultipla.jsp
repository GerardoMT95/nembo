				...
				<table summary="Elenco Interventi" class="table table-hover table-bordered table-condensed tableBlueTh" data-show-columns="true">
					<thead>
						<tr>
							<th>Progr.</th>
							<th>Intervento</th>
							<c:if test="${multiMisura}"><th>Oper.</th></c:if>
							<th>Spesa<br />ammessa
							</th>
							<th>Contributo</th>
					...
					<tbody>
						<c:forEach items="${interventi}" var="intervento">
							<tr>
								...
								<c:if test="${multiMisura}"><td style="vertical-align: middle; text-align: center">${intervento.codiceLivello}</td></c:if>
								...
								<td style="vertical-align: middle; text-align: center; width:160px"><m:textfield name="importoSpesa_${intervento.idIntervento}" style="width:128px"
