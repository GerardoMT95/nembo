...
<body>
        ...
        <strong><c:out value="${msgIVA}" /></strong>
              ...
              <th data-field="importoDisponibilePrec" data-totale="true" data-formatter="numberFormatter2" data-adder="importoAdder" data-visible="false">Importo
                non<br />riconosciuto<br />non sanzionabile
							...
							<th data-field="contributoRichiesto" data-totale="true" data-formatter="numberFormatter2" data-adder="contributoRichiestoAdder">Contributo<br />richiesto
							</th>
							...
							<th data-field="codiceLivello" data-visible="false" data-totale="false">Operazione</th>
						</tr>
					</thead>
				</table>
				<br />
          ...
          <td id ="potenzialeContributoErogabile" style="padding-left:20px" class="numero"><fmt:formatNumber pattern="###,##0.00" value="${potenzialeErogabile}" />
                &euro;</td>
          </tr>
          <tr>
          <th>Totale Sanzioni/Riduzioni precedenti</th>
          <td id ="totaleSanzioni" style="padding-left:20px" class="numero"><fmt:formatNumber pattern="###,##0.00" value="${totaliSanzioni}" />
                &euro;</td>
          </tr>
          </table>
        </m:panel>
    ...
    function contributoRichiestoAdder(rows, field)
    {
      var __sum = 0;
      var __sumContributo=0;
      $(rows).each(function(index, currentRow)
      {
        var value = currentRow[field];
        if (value!=null && !isNaN(value) && value.length != 0)
