				...
				<table summary="dettaglio" id='tblInterventi' summary="Elenco Interventi" class="table table-hover table-bordered tableBlueTh show-totali" data-toggle="table"
					...
					<thead>
						<tr>
							...
							<th data-field="speseDaRendicontare" data-totale="true" data-formatter="numberFormatter2" data-adder="importoAdder" data-visible="false">Spese
								ancora<br />da rendicontare
							</th>
