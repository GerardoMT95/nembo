							...
							<c:forEach items="${operazioni}" var="o">
								<tr>
									...
									No
											...
											<c:otherwise><c:if test="${o.flagInadempVincolata=='S'}">S�</c:if></c:otherwise>
										</c:choose>
									...
									No
											...
											<c:otherwise><c:if test="${o.flagInadempCondizionata=='S'}">S�</c:if></c:otherwise>
										</c:choose>
