			...
			<h4>Sono stati selezionati ${ids.size()} record, sei sicuro di volerli eliminare?</h4>
				...
				<div class="stdMessagePanel">
					...
					<div class="alert alert-danger" hidden="true" id="configErr">
						<p>
							<strong>Attenzione!</strong><br />
							Si � verificato un errore della configurazione del quadro "Riduzioni e sanzioni", l'aggiornamento del 
							contributo erogabile � previsto solo per le istruttorie delle domande di acconto e saldo. 
							Non � possibile proseguire con l'operazione.
						</p>
					</div>
				</div>
	<div class="alert alert-warning" role="alert">
			In caso di
			conferma dell'operazione il sistema aggiorner� il contributo
