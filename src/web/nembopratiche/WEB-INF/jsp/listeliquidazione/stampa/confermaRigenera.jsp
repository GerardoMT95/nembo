...
<b:error />
<form  method="post" class="form-horizontal" id="insertForm" style="margin-top: 1em" target="hiddenIFrame">
	${messaggio}
	...
	<script type="text/javascript">
	 function confermaRigenera()
	 {
		 let w=500;
		 let h=160;
		 window.open("../cunembo230/rigenera_${idListaLiquidazione}.do","attendere_prego_stampe_"+(new Date().getTime()),'width='+w+',height='+h+',menubar=no,resizable=no,titlebar=no,toolbar=no,scrollbar=no');
