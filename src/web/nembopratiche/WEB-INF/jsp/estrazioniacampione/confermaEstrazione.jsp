    	...
    	$.ajax(
	      {
	        ...
	        error : function(xhr, status, text)
	        {
	          ...
	          showRedirectMessageBox("Errore", "Si � verificato un errore di sistema e non � possibile completare la registrazione, se il problema persiste contattare l'assistenza.", 'modal-large','../cunembo219/index_${idNumeroLotto}.do');
	          chiusuraInCorso=false;
	        }
	      });
    }
