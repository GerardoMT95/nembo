	...
	<input type="hidden" id="filtroEstrazioni" value='${filtroAziende.get("estrazioniTable")}' >
		...
		<thead>
        	<tr>
				...
				<th data-field="numeroEstrazione" data-sortable = "true" >Numero estrazione<a style="padding-left: 1em;color:white;" class="icon icon-list" rel="tooltip" data-placement="top"  title="Il numero � univoco nell'ambito del tipo di estrazione."></a></th>				
