		...
		<table summary="info totali" id="tableInfoTotali" class="bootstrap-table table table-hover table-striped table-bordered tableBlueTh ">
			<tbody>	
				<tr>
					...
					<th>Numero Estrazione <a style="padding-left: 1em;" class="icon icon-list" rel="tooltip" data-placement="top"  title="Il numero � univoco nell'ambito del tipo di estrazione."></a></th>
