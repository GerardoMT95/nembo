...
<p:messaggistica/>
	...
	<div class="container-fluid" id="content">
		...
		<div class="alert alert-warning" role="alert">Proseguendo il sistema effettuer&agrave; l'elaborazione dell'estrazione a campione. Continuare?</div>
				<div class="col-sm-12" >
		<m:checkBox cssClass="chkRegistra" chkLabel="Sono gi� state raggiunte le percentuali previste" name="chkRegistra" value="S" preferRequestValues="${prfvalues}"></m:checkBox>
		</div>
    	...
    	$.ajax(
	      {
	        ...
	        error : function(xhr, status, text)
	        {
	          ...
	          showRedirectMessageBox("Errore", "Si � verificato un errore di sistema e non � possibile completare l'estrazione, se il problema persiste contattare l'assistenza.", 'modal-large','../cunembo219/index_${idNumeroLotto}.do');
	          chiusuraInCorso=false;
	        }
	      });
    }
