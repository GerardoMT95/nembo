...
<body>
  ...
  <p:utente/>
	<p:breadcrumbs cdu="CU-NEMBO-107-I"/>
	<p:messaggistica/><p:testata cu="CU-NEMBO-107-I" />
	<form:form action="" modelAttribute="" method="post" class="form-inline" >
		...
		<b:error />
			...
			<div class="puls-group" style="margin-top:2em">
			 <div class="pull-left">
		        <button type="button" onclick="forwardToPage('../cunembo106i/index.do');"  class="btn btn-default">annulla</button>
		      </div>
