...
<body>
	...
	<div class="container-fluid" id="content">
		...
		<div id="errorBoxDiv" class='alert alert-danger col-md-12' style="display:none;">
			<h4>Non � possibile modificare pi&ugrave; danni contemporaneamente se almeno uno di quelli selezionati &egrave; di tipo Terreni Ripristinabili, Terreni Non Ripristinabili, Piantagioni Arboree o Allevamenti.</h4>
		</div>
