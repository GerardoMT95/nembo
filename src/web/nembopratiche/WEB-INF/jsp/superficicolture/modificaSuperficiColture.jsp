		...
		<form name="formModificaSuperficiColture" id="formModificaSuperficiColture" action="../cunembo299m/conferma_modifica.do" method="POST">
				...
				>
					...
					<tbody>
						...
						<tr>
							<th class="col-md-4">Unit� foraggere (totali)</th>
							<td class="col-md-8" colspan="2">
						...
						<tr>
							...
							<td class="col-md-2">Unit� di Misura:</td>
							<td class="col-md-6">Quantit�:</td>								
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
							Note: per segnalare l'assenza di reimpieghi � sufficiente scrivere 0 nel campo Quantit�.
							</td>
						</tr>	
