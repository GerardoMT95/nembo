			...
			<div class="alert alert-info">
				<p>
					<strong>Attenzione!</strong><br />
					 Deselezionando "Controllo in loco" verranno eliminati i tutti i dati relativi al controllo in loco.
				</p>
			</div>
		</div>
	</c:if>
	...
	<div class="col-sm-12" style="padding-right: 0px !important">
		...
		<div class="row">
			<div class="row form-group">
				<label class="control-label col-sm-3">Controllo in loco</label>
				<div class="col-sm-9">
