...
<body>
	...
	<div class="container-fluid" id="content">
		...
		<form action="../cunembo297i/inserisci_scorte.do" method="post" onsubmit="unitaDiMisuraToHidden()"> 
			...
			<div class="col-md-8">
				<m:textfield id="quantita" name="quantita" label="Quantit�" preferRequestValues="${preferRequest}"></m:textfield>
			</div>
			<div class="col-md-4">
				
				<div class="col-md-12">
				<m:select id="unitaDiMisura" list="${elencoUnitaMisura}" name="unitaDiMisura" label="Unit� di Misura" disabled="true" preferRequestValues="${preferRequest}"></m:select>
