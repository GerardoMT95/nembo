...
<form method="post" class="form-horizontal" id="formNuovaVisita">
	...
	<m:selectchoice label="Funzionario istruttore *" id="idTecnico" name="idTecnico" preferRequestValues="${preferRequest}" list="${tecnici}" listChoice="${ufficiZona}" selectedChoice="STESSO_UFFICIO"/>
  ...
  initializeDatePicker();
    function confermaModifica()
    {
      $.ajax(
          {
            type : "POST",
            url : '../cunembo165m/popup_inserisci_visita.do',
