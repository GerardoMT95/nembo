...
<form method="post" class="form-horizontal" id="formModificaEsitoTecnico">
	<m:selectchoice label="Funzionario istruttore *" id="idTecnico" name="idTecnico" selectedValue="${esito.idTecnico}" preferRequestValues="${preferRequest}" list="${tecnici}" listChoice="${ufficiZona}" selectedChoice="STESSO_UFFICIO"/>
  ...
  initializeDatePicker();
    function confermaModifica()
    {
      $
          ...
          {
            type : "POST",
            url : '../cunembo165m/popup_modifica_esito_tecnico.do',
            ...
            {
              writeModalBodyError("Si � verificato un errore grave nell'accesso alla funzionalit� di aggiornamento. Se il problema persistesse si prega di contattare l'assistenza tecnica");
            }
          });
    }
  </script>
