		...
		<div class="row">
			<div class="moduletable">
				<ul class="breadcrumb">
					...
					<li><a href="index.do">Reportistica</a> <span class="divider">/</span></li>
	...
	<div class="container-fluid form-horizontal"  id="content" style="margin-bottom:2em">
		...
		<div id="dettEstrazioneCnt" style="display:none;overflow-x:auto ">
			<table summary="dettaglio estrazioni" id="dettEstrazioneTable" class="bootstrap-table table table-hover table-striped table-bordered tableBlueTh" 
				...
				<thead>
		        	<tr>
		        		<th data-switchable="false" data-width="40px"><a href="#" title="esporta in excel" onclick="forwardToPage('../cunembo284/downloadExcelReport.xls')" class="ico24 ico_excel"></a></th>
