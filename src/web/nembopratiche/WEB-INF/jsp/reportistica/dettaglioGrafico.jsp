...
<body>
		...
		<div class="row">
			<div class="moduletable">
				<ul class="breadcrumb">
					...
					<li><a href="mainreport_${idBandoGrafici}.do">Reportistica</a> <span class="divider">/</span></li>
	...
	<div class="container-fluid" id="content" style="margin-bottom:5em">
		<div class="alert alert-info" role="alert">Bando: <b>${denominazioneBando}</b></div>
