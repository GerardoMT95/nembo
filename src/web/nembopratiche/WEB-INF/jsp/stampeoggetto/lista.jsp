...
<!--LISTA_STAMPE-->
<%--IMPORTANTE: non rimuovere il commento precedente, serve al javascript per capire che la pagina � stata generata correttamente --%>
<form data-comment="<!--LISTA_STAMPE-->">
	<p:table list="${stampe}">
		<p:tcol property="idOggettoIcona" type="NO_TEXT" cssClass="center">
			...
			<%-- Le icone nomeIconaStampaVisualizza e nomeIconaStampaGenera sono mutuamente esclusive, una viene visualizzata quando il pdf � su index, l'altra quando � ancora da generare. 
			     ...
			     � null il custom tag NON visualizza l'icona) --%>
  ...
  $.ajax(
   {
     ...
     error:
       function(a, b)
       { 
         alert('Si � verificato un errore di sistema');
       }
    })
  return false;
}
