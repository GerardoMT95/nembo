            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = that.options.cardView ? ['<div class="card-view">',
                        ...
                        '</div>'
                    ].join('') : [sprintf('<td   %s %s %s %s %s %s data-field="%s">', id_, class_, style, data_, rowspan_, title_,field),
                        value,
                        '</td>'
                    ].join('');
...
!function(a){"use strict";a.fn.bootstrapTable.locales["it-IT"]={formatLoadingMessage:function(){return"Caricamento in corso..."},formatRecordsPerPage:function(a){return a+" records per pagina"},formatShowingRows:function(a,b,c){return"Pagina "+a+" di "+b+" ("+c+" records totali)"},formatSearch:function(){return"Cerca"},formatNoMatches:function(){return"Nessun record trovato"},formatRefresh:function(){return"Rinfrescare"},formatToggle:function(){return"Alternare"},formatColumns:function(){return"Colonne"}},a.extend(a.fn.bootstrapTable.defaults,a.fn.bootstrapTable.locales["it-IT"])}(jQuery);
